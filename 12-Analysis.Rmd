...
Dabei muss noch festgelegt werden, aus welchem Zahlbereich $a$ und die $a_n$ stammen. 


```{r Grenzwert, echo=FALSE, fig.cap="Visualisierung zum Grenzwertbegriff (Grafik: Jörg Enders)", fig.align='center', out.width='90%'}
