...
Die Veranstaltung *Stoffdidaktik Mathematik*^[Die Modulbeschreibung finden Sie bei [PULS](https://puls-qis.uni-potsdam.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=modulansicht&publishConfFile=modulverwaltung&publishSubDir=up/modulbearbeiter&&modul.modul_id=3155&menuid=&topitem=&subitem=).] besteht aus einer **Vorlesung (2 SWS)** und einem zugehörigen **Seminar (2 SWS)**.

Im Wintersemester 2025/26 wird die **Vorlesung semesterbegleitend** stattfinden. Das **Seminar** können Sie entweder **parallel zur Vorlesung** im Wintersemester oder **semesterbegleitend** im Sommersemester 2026 besuchen.
...
Sie halten einen **Seminarvortrag** als Voraussetzung für die Zulassung zur Modulprüfung und fassen Ihre Erarbeitungen in einer **Hausarbeit** zusammen, die als Modulprüfung dient. 
