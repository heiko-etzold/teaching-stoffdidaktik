...
\urlstyle{same}
\hypersetup{
  pdftitle={Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2025/26},
...
\title{Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2025/26}
\author{Dr.~Heiko Etzold, Universität Potsdam}
\date{Letzte Änderung: 08.11.2025}
...
\chapter*{Über dieses Dokument}\label{index}
...
Als Quellenangabe für das Skript wird empfohlen:

\begin{quote}
Etzold, H. (2025). \emph{Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2025/26} (Version vom 08.11.2025). \url{https://stoffdidaktik.heiko-etzold.de/2025}
\end{quote}

Die Vorlesungsskripte der letztjährigen Veranstaltungen finden Sie unter:

\begin{itemize}
\tightlist
\item
  \url{https://stoffdidaktik.heiko-etzold.de/2024}
\item
...
Die Veranstaltung \emph{Stoffdidaktik Mathematik}\footnote{Die Modulbeschreibung finden Sie bei \href{https://puls-qis.uni-potsdam.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=modulansicht&publishConfFile=modulverwaltung&publishSubDir=up/modulbearbeiter&&modul.modul_id=3155&menuid=&topitem=&subitem=}{PULS}.} besteht aus einer \textbf{Vorlesung (2~SWS)} und einem zugehörigen \textbf{Seminar (2~SWS)}.

Im Wintersemester 2025/26 wird die \textbf{Vorlesung semesterbegleitend} stattfinden. Das \textbf{Seminar} können Sie entweder \textbf{parallel zur Vorlesung} im Wintersemester oder \textbf{semesterbegleitend} im Sommersemester 2026 besuchen.
...
Sie halten einen \textbf{Seminarvortrag} als Voraussetzung für die Zulassung zur Modulprüfung und fassen Ihre Erarbeitungen in einer \textbf{Hausarbeit} zusammen, die als Modulprüfung dient.
...
\tightlist
\item
  Folien zum Kapitel 1 (\href{files/Stoffdidaktik2025-01-VierEbenenAnsatz.pdf}{pdf}, \href{files/Stoffdidaktik2025-01-VierEbenenAnsatz.key}{Keynote})
\item
...
Über die \textbf{Spezifizierung} wird ermittelt, welche tatsächlichen Inhalte zu einem mathematischen Thema \emph{ausgewählt} werden, während die \textbf{Strukturierung} analysiert, wie diese Elemente in einem Lernpfad \emph{angeordnet} werden können.
...
Er diskutiert, welchen Einfluss die jeweilige Sichtweise auf dem Maßbereich hat, wie Winkel überhaupt gemessen werden können und wie mit Winkeln operiert werden kann.

So wird beispielsweise die Frage diskutiert, was passiert, wenn man ein geordnetes Strahlenpaar in der orientierten Ebene spiegelt (vgl. \citeproc{ref-Freudenthal:1973}{Freudenthal, 1973b, 443~ff.}).
...
Im Rahmen der Stoffdidaktik-Veranstaltung sollen beide Ansätze aufgegriffen und an konkreten Beispielen versucht werden, die Fragen der \textcolor{formalColor}{formalen Ebene} zu beantworten.

\subsection{Geeignete Quellen}\label{geeignete-quellen}
...
Für eine Vertiefung mit der Didaktik der Sachgebiete eignen sich u.~a. die in Abschnitt \ref{geeignete-quellen} dargestellten Quellen. Weiterhin werden Sie im Masterstudium im Modul \emph{Ausgewählte Themen der Mathematikdidaktik}\footnote{siehe Modulbeschreibung zum Modul \href{https://puls-qis.uni-potsdam.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=modulansicht&publishConfFile=modulverwaltung&publishSubDir=up/modulbearbeiter&&modul.modul_id=3186&menuid=&topitem=&subitem=}{MAT-LS-D3 bei PULS}} die Möglichkeit haben, sich mit der Didaktik einzelner Sachgebiete näher auseinanderzusetzen.
...
\section{Stoffelementkategorien}\label{stoffelementkategorien}

Eine weitere Strukturierung mathematischen Wissens kann darin bestehen, den Blick darauf zu lenken, wie dieses Wissen angeeignet wird. So können ähnliche Aneigungsprozesse Motivation bieten, das Wissen entsprechend zu strukturieren und dies dann für die Gestaltung von Lehr-Lern-Prozessen nutzbar zu machen. Die Bezeichnung \emph{Stoffelementkategorie} nutzt u.~a. Zais (\citeproc{ref-Zais2003}{2003}), während Vollrath \& Roth (\citeproc{ref-Vollrath2012}{2012, 45~f.}) von \emph{Arten mathematischen Wissens} sprechen. Es können drei Kategorien unterschieden werden.
...
Einige Autoren zählen zu den Verfahren auch heuristische Strategien zum Problemlösen oder die Anwendung des Permanenzprinzips (vgl. \citeproc{ref-Steinhofel1988}{Steinhöfel et al., 1988, S. 23}). Vollrath \& Roth (\citeproc{ref-Vollrath2012}{2012, S. 46}~ff.) ergänzen inhaltlich ähnlich:
...
Entscheidend ist beim Aufstellen von Permanenzreihen jedoch, dass der Übergang von einer Zeile zur nächsten auf einem entsprechenden Rechengesetz beruht. In Abbildung \ref{fig:Permanenz} ist dies das Distributivgesetz \((a-1) \cdot b = a \cdot b - b\). Vernachlässigt man die Existenz einer Übergangsregel, lassen sich plausibel erscheinende Muster fortsetzen (wie \(0^3 = 0\), \(0^2 = 0\), \(0^1 = 0\)), die dann allerdings zu falschen Schlussfolgerungen (\(0^0 = 0\)) führen. Im dargestellten Beispiel kann die Übergangsregel \(a^{m-1} = a^m : a\) wegen \(a = 0\) nicht angewandt werden.

Weitere Hinweise zum Einsatz des Permanenzprinzips im Mathematikunterricht finden Sie zum Beispiel bei Hoffkamp \& Lensing (\citeproc{ref-Hoffkamp2024}{2024}).
...
\chapter{Sinn und Bedeutung}\label{sinn-und-bedeutung}
...
\tightlist
\item
  Folien zum Kapitel 3 (\href{files/Stoffdidaktik2025-03-SinnUndBedeutung.pdf}{pdf}, \href{files/Stoffdidaktik2025-03-SinnUndBedeutung.key}{Keynote})
\end{itemize}
\end{quote}

\section{Allgemeine Hinweise}\label{allgemeine-hinweise-1}
...
Im Folgenden wird daher mit der gesellschaftlichen Sicht die \textbf{Bedeutung} eines Lerngegenstands verfolgt.
Dabei bietet es sich an, mehrere Perspektiven zu verfolgen. Angelehnt an Feldt-Caesar (\citeproc{ref-Feldt-Caesar2017}{2017, 124~f.})\footnote{Dargestellt sind bei Feldt-Caesar (\citeproc{ref-Feldt-Caesar2017}{2017, 124~f.}) Zielperspektiven zur Auswahl von Lerngegenständen zur Ausbildung von Mindesstandards, aufbauend auf Arbeiten von Bruder et al. (\citeproc{ref-Bruder2015b}{2015}). Die Grundgedanken wurdn hier übernommen und hinsichtlich der Bedeutung von Lerngegenständen angereichert.} können dies sein:

\begin{itemize}
\item
  \textbf{fachwissenschaftliche Bedeutung:} Hier wird untersucht, inwieweit der jeweilige Lerngegenstand für die Mathematik selbst bedeutsam ist, auch hinsichtlich der Anschlussfähig innerhalb der Fachsystematik. Es bietet sich bei der Diskussion eine Orientierung an \textbf{\emph{fundamentalen Ideen}} der Mathematik an (siehe Abschnitt \ref{fundamentale-ideen}).
\item
  \textbf{gesellschaftliche Bedeutung:} Dabei wurd u.~a. die Nützlichkeit und Anwendbarkeit des Lerngegenstands für die Gesellschaft diskutiert, also bspw. welchen Beitrag ein bestimmter Lerngegenstand leistet, gesellschaftliche Probleme zu lösen. Die Mathematik dient hier »als Mittel, um Probleme aus Alltag, Beruf, Berufsausbildung oder Studium zu lösen« (\citeproc{ref-Feldt-Caesar2017}{Feldt-Caesar, 2017, S. 125}). Daher kann auch die Bedeutung des jeweiligen Lerngegenstands für die Berufs- oder Studienorientierung Bestandteil der Diskussion sein.
\item
  \textbf{historische und kulturelle Bedeutung:} Nicht zuletzt dient Mathematik auch der kulturellen Bildung, weshalb für einzelne Lerngegenstände auch diskutiert werden sollte, welchen Beitrag diese dafür leisten. Hier bietet es sich z.~B. an, die historische Entwicklung eines Lerngegenstands nachzuzeichnen, um dessen Bedeutung hervorzuheben.
\end{itemize}
...
Auf individueller Ebene wird vom \textbf{Sinn} gesprochen, mit dem ein Lerngegenstand bei einzelnen Schülerinnen und Schülern verbunden wird. Eine in der deutschsprachigen Mathematikdidaktik verbreitete Theorie zur Beurteilung der Sinnkonstituierung ist die Orientierung an \textbf{Grundvorstellungen} (siehe Abschnitt \ref{grundvorstellungen}).
...
\begin{definition}[Fundamentale Ideen]
\protect\hypertarget{def:fundementaleIdeen}{}\label{def:fundementaleIdeen}
...
Im Rahmen des Projektmoduls \emph{Erweitertes Fachwissen für den schulischen Kontext in Mathematik}\footnote{siehe Modulbeschreibung zum Modul \href{https://puls-qis.uni-potsdam.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=modulansicht&publishConfFile=modulverwaltung&publishSubDir=up/modulbearbeiter&&modul.modul_id=3156&menuid=&topitem=&subitem=}{MAT-LS-7 bei PULS}} werden Sie insbesondere Bezüge zwischen Schul- und Hochschulmathematik auf Basis fundamentaler Ideen herstellen, wofür die Inhalts- und Tätigkeitsideen von hoher Relevanz sind.
...
\addcontentsline{toc}{subsubsection}{Horizontal- und Vertikalkriterium}
...
\addcontentsline{toc}{subsubsection}{Zeit- und Sinnkriterium}
...
\section{Grundvorstellungen}\label{grundvorstellungen}

\subsection{Begriffsklärung}\label{grundvorstellungen-begriffsklaerung}
...
\subsection{GV und Stoffdidaktik}\label{gv-und-stoffdidaktik}
...
\subsubsection{Bruchzahlen}\label{bruchzahlen}
...
\subsubsection{Negative Zahlen}\label{negative-zahlen}
...
\chapter{Darstellungen und Arbeitsmittel}\label{darstellungen-und-arbeitsmittel}
...
\item
  Sie kennen ausgewählte Arbeitsmittel für den Mathematikunterricht.\textgreater{}
\end{itemize}
...
\tightlist
\item
  Folien zum Kapitel 4 (\href{files/Stoffdidaktik2025-04-DarstellungenUndArbeitsmittel.pdf}{pdf}, \href{files/Stoffdidaktik2025-04-DarstellungenUndArbeitsmittel.key}{Keynote})
\end{itemize}
\end{quote}

\section{Darstellungen}\label{darstellungen}

\subsection{Begriffsklärung}\label{darstellungen-begriffsklaerung}
...
Mit Salle et al. (\citeproc{ref-Salle2023}{2023, S. 437}, Hervorhebungen H.E.) wird festgelegt:

\begin{definition}[Darstellungen]
\protect\hypertarget{def:Darstellungen}{}\label{def:Darstellungen}{[}Mathematische{]} \textbf{Darstellungen} sind {[}\ldots{]} alles \textbf{empirisch Wahrnehmbare}, das auf \textbf{mathematische Beziehungen, Objekte, Strukturen und Prozesse verweisen} kann.
...
Dabei wird häufig zwischen \textbf{\emph{enaktiven}}, \textbf{\emph{ikonischen}} und \textbf{\emph{symbolischen Darstellungen}} unterschieden, mehr Informationen dazu liefern ebenfalls Salle et al. (\citeproc{ref-Salle2023}{2023, 433~f.}).

\subsection{Vorstellungen ausbilden}\label{vorstellungen-ausbilden}

Mithilfe des Einsatzes von Darstellungen ist es möglich, den Verständnisaufbau zu mathematischen Lerngegenständen zu unterstützen. Salle et al. (\citeproc{ref-Salle2023}{2023, 441~ff.}) schlagen hierzu drei prinzipielle Wege vor, die an einigen Beispielen illustriert werden:

\begin{itemize}
\item
  \textbf{Veränderungen beim Darstellungswechsel untersuchen.} Wird von einer Darstellung eines Lerngegenstandes in eine andere übergegangen, ist von besonderem Interesse, \textbf{was (und warum es) sich dabei verändert und was gleich bleibt}. So ist es möglich, die wesentlichen Strukturen, die den Lerngegenstand auszeichnen, herauszuarbeiten und hervorzuheben.

  So können beispielsweise zu einer \emph{linearen Funktion} die Wertetabelle und der Graph miteinander in Bezug gebracht werden. Dabei könnte untersucht werden, wo im Graphen die Wertepaare der Tabelle auftreten und wie sich das additive Verhalten innerhalb der Tabelle im Aussehen des Graphen wiedererkennen lässt (siehe Abbildung \ref{fig:Darstellungswechsel}).

  \begin{figure}

    {\centering \includegraphics[width=0.85\linewidth]{pictures/4-Darstellungswechsel} 

    }

    \caption{Wertetabelle und Graph einer linearen Funktion}\label{fig:Darstellungswechsel}
    \end{figure}

  Diese prinzipielle Ansicht spiegelt sich auch im \textbf{\emph{EIS-Prinzip}}\footnote{E, I und S stehen hier für enaktiv, ikonisch und symbolisch.} bzw. \textbf{\emph{Prinzip der Darstellungsvernetzung}} wider. Mehr dazu und allgemein zu \emph{didaktischen Prinzipien} finden Sie bspw. bei Heitzer \& Weigand (\citeproc{ref-Heitzer2020a}{2020}).
\item
  \textbf{Operative Veränderungen von Darstellungen untersuchen.} Auf ähnliche Weise können auch Veränderungen innerhalb einer Darstellung untersucht werden. Dabei werden Objekte bzw. Operationen systematisch variiert und untersucht, welchen Einfluss dies auf die anderen beteiligten Objekte oder Operationen nimmt. Eine Leitfrage könnte sein: \textbf{Wie verändert sich \ldots, wenn ich \ldots{} verändere?}

  So kann etwa in der symbolischen Darstellung \(2\cdot(3+7)=20\) untersucht werden, wie sich das Ergebnis verändert, wenn der zweite Summand innerhalb der Klammer systematisch um \(1\) erhöht wird, also \(2\cdot(3+8)\) usw. betrachtet wird. Nach dem Aufstellen einer Vermutung (Erhöhung des Ergebnisses um 2) kann untersucht werden, welchen Einfluss die Variation des Vorfaktors (also \(3\cdot(3+7)=30\) usw.) hat. So kann systematisch das \emph{Distributivgesetz} verinnerlicht werden.

  Ein solches Vorgehen spiegelt sich auch im \textbf{\emph{operativen Prinzip}} wider und kann über das \textbf{\emph{operative Durcharbeiten}} realisiert werden (vgl. \citeproc{ref-Gunster2020}{Günster \& Ruppert, 2020}).
\item
  \textbf{Reflexion und sprachliche Begleitung.} Indem die Darstellung selbst und ggf. die (tatsächlichen oder gedanklichen) Handlungen, die mit ihr durchgeführt wurden, im Nachgang reflektiert werden, kann ebenfalls ein Vorstellungsaufbau erfolgen. Auf diese Weise können die \textbf{durchgeführten Handlungen mit der mathematischen Struktur in Bezug} gebracht werden.

  Wird beispielsweise die Sachsituation, dass eine Gruppe von Personen die Kosten für eine 90~€ teure Feier gleichmäßig untereinander aufteilt, in einem Funktionsgraphen visualisiert, so dürfen die Punkte aufgrund des \emph{Definitionsbereichs} nicht miteinander verbunden werden. Hier könnte reflektiert werden, warum die Linie im Graphen nur gestrichelt dargestellt ist, um auf die Besonderheit des Definitionsbereichs aufmerksam zu machen.

  \begin{figure}

    {\centering \includegraphics[width=0.75\linewidth]{pictures/4-Definitionsbereich} 

    }

    \caption{Graph zu einer Funktion mit natürlichem Definitionsbereich}\label{fig:Definitionsbereich}
    \end{figure}

  Ein weiterer hilfreicher Baustein ist in diesem Zusammenhang, die Handlungen zu \textbf{versprachlichen}. So ist es möglich, den Übergang von der tatsächlichen zur geistigen Handlung zu unterstützen. Abbildung \ref{fig:GVverinnerlichen} zeigt eine entsprechende Schrittfolge zum Aufbau von Grundvorstellungen, wie sie Wartha \& Schulz (\citeproc{ref-Wartha2011}{2011, S. 11}) vorschlagen (wobei die dort verwendeten Farben nichts mit den hier im Skript genutzten Farben für die vier Ebenen zu tun haben).

  (ref:GVverinnerlichen) Aufbau von Grundvorstellungen nach Wartha \& Schulz (\citeproc{ref-Wartha2011}{2011, S. 11})

  \begin{figure}

    {\centering \includegraphics[width=0.75\linewidth]{pictures/4-GVverinnerlichen} 

    }

    \caption{(ref:GVverinnerlichen)}\label{fig:GVverinnerlichen}
    \end{figure}
\end{itemize}

\section{Arbeitsmittel}\label{arbeitsmittel}

\subsection{Begriffsklärung}\label{arbeitsmittel-begriffsklaerung}
...
Diese Begriffsauffassung soll noch durch einige Bezüge aus der Tätigkeitstheorie angereichert werden. Dort werden Lernmittel im Rahmen der Lerntätigkeit eingesetzt und als ein spezifisches Lernmittel dient dabei das Konzept des \textbf{\emph{Lernmodells}}. Lernmodelle sind »sinnliche Stützen geistigen Handelns« (\citeproc{ref-Giest2006}{Giest \& Lompscher, 2006, S. 225}) und können bspw. Zeichnungen, strukturierte Darstellungen, digitale Anwendungen usw. sein. Sie haben als Modelle dabei den Vorteil, dass sie »nicht die konkreten Merkmale der einzelnen Erscheinungen oder Situationen, sondern nur konstitutive, im gegebenen Kontext wesentliche Merkmale und Relationen enthalten, also \emph{abstrakt} sind« (\citeproc{ref-Lompscher1985a}{Lompscher, 1983, S. 64}, Hervorhebung im Original). Gleichzeitig sind sie aber auch »\emph{anschauliche} Abbildungen und machen damit die grundlegenden Zusammenhänge und Wesensmerkmale der Wahrnehmung und Vorstellung zugänglich« (\citeproc{ref-Lompscher1985a}{Lompscher, 1983, S. 64}, Hervorhebung im Original).

\begin{figure}

{\centering \includegraphics[width=0.25\linewidth]{pictures/4-Lernmodell} 
...
Ein \textbf{Arbeitsmittel} ist eine \textbf{materielle oder materialisierte\footnote{Damit sind auch Abbildungen, Strukturdiagramme oder Apps eingeschlossen.} Darstellung} eines Lerngegenstand, die es ermöglicht, mit dem Lerngegenstand zu \textbf{operieren}. Damit muss ein Arbeitsmittel folgende Bedingungen erfüllen:
...
\subsection{Beispiel Gleichungen}\label{beispiel-gleichungen}
...
\subsubsection{Der Gleichungsbegriff}\label{der-gleichungsbegriff}
...
\subsubsection{Umformungen verstehen}\label{umformungen-verstehen}
...
\paragraph{Waage-Modell}\label{waage-modell}
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/4-Waage} 
...
\paragraph{Streichholzschachtel-Modell}\label{streichholzschachtel-modell}
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/4-Streichholz} 
...
\paragraph{Strecken-/Pfeil-Modell}\label{strecken-pfeil-modell}
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/4-Pfeile} 
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/4-negativePfeile} 
...
\tightlist
\item
  Folien zum Kapitel 5 (\href{files/Stoffdidaktik2025-05-KernideenUndKontexte.pdf}{pdf}, \href{files/Stoffdidaktik2025-05-KernideenUndKontexte.key}{Keynote})
\end{itemize}
\end{quote}
...
\chapter{Typische Unterrichtssituationen}\label{typische-unterrichtssituationen}
...
\tightlist
\item
  Sie können typische Unterrichtssituationen im Mathematikunterricht benennen und beschreiben.
\item
...
\item
  Ihnen ist die Bedeutsamkeit von Identifizierungs- und Realisierungshandlungen in der Stofferarbeitung bewusst.
\item
...
\tightlist
\item
  Folien zum Kapitel 6 (\href{files/Stoffdidaktik2025-06-TypischeUnterrichtssituationen.pdf}{pdf}, \href{files/Stoffdidaktik2025-06-TypischeUnterrichtssituationen.key}{Keynote})
\end{itemize}
\end{quote}

\section{Tätigkeitstheoretische Grundlagen}\label{taetigkeitstheoretische-grundlagen}

\subsection{Allgemeine Hinweise}\label{taetigkeitstheorie-allgemeine-hinweise}
...
In den bisherigen Ausführungen tauchte bereits mehrfach der Begriff \emph{Lernmittel} auf. Nach Wygotski (\citeproc{ref-Wygotski1985a}{1985}) erfolgt eine Interaktion eines Individuums mit einem Gegenstand niemals direkt, sondern geschieht stets über ein \textbf{vermittelndes Werkzeug}. Es kann sich dabei um \emph{echte} Werkzeuge (wie Maschinen, Geräte und andere Hilfsmittel handeln) oder um \emph{psychische} Werkzeuge handeln, also Gesten, die Sprache, Abbildungen und Skizzen oder ähnliches. Entscheidend ist, dass dieses vermittelnde »Ding« für das Individuum die Funktion eines Vermittlers erfüllt.
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/6-ZdnE} 
...
\section{Sicherung des Ausgangsniveaus}\label{sicherung-des-ausgangsniveaus}

Bisher unerwähnt blieb, dass die Lernhandlungen selbstverständlich auf Vorkenntnisse und -fertigkeiten aufbauen und dieser bedürfen. Es ist daher unerlässlich, das für die neu zu erwerbenden Lernhandlungen benötigte \textbf{Ausgangsniveau zu sichern} (was dann die \emph{Zone der aktuellen Leistung} charakterisiert). Dies kann in \textbf{Wiederholungsphasen} zum aktuell benötigten Stoff erfolgen, dauerhaft und langfristig auch in (unbenoteten) \textbf{täglichen Übungen / vermischten Kopfübungen} zum »Wachhalten von Basiswissen« (siehe auch \citeproc{ref-Bruder2008b}{Bruder, 2008}).

Auf konkrete Möglichkeiten der methodischen Gestaltung derartiger Phasen soll an dieser Stelle verzichtet werden -- Sie sind vielmehr aufgefordert, geeignete Literatur zu recherchieren.

\section[Stofferarbeitung]{\texorpdfstring{Stofferarbeitung\footnote{In der Originalquelle bei Bruder (\citeproc{ref-Bruder1991}{1991}) wird diese Unterrichtssituation mit \emph{Stoffvermittlung} bezeichnet. Hier im Skript wurde jedoch die Bezeichnung \emph{Stofferarbeitung} verwendet, um den (fälschlichen) Eindruck einer frontal gestalteten Unterrichtsphase zu vermeiden.}}{Stofferarbeitung}}\label{stofferarbeitung}

\subsection{Lernhandlungen einführen}\label{lernhandlungen-einfuxfchren}

Am neu zu erlernenden Lerngegenstand werden die Schülerinnen und Schüler nun \textbf{an die Ausführung geeigneter Lernhandlungen herangeführt}, was bspw. über ein Vorführen und Erklären durch die Lehrkraft erfolgen kann. Die Ausführung durch die Schülerinnen und Schüler darf jedoch nicht mit einem \emph{Nachahmen} verwechselt werden. Vielmehr erfolgen die Handlungen \textbf{einsichtig} und das \textbf{Lernziel verfolgend}. Je nach Vorkenntnissen können die Schülerinnen und Schüler auch, angeregt durch entsprechende Aufgabenstellungen, selbstständig die neuen Lernhandlungen durchführen, wobei nicht davon auszugehen ist, dass sie bereits über alle Voraussetzungen verfügen, die Lernhandlungen vollumfänglich zu nutzen (denn sonst wäre die zugehörige Anforderungssituation nicht in der Zone der nächsten Entwicklung gewesen). Die Kapitel \ref{begriffe}, \ref{zusammenhaenge} und \ref{verfahren} stellen einige Beispiele zur Einführung von Lernhandlungen bei Begriffen, Zusammenhängen und Verfahren dar.

\subsection{Orientierungshilfen}\label{orientierungshilfen}
...
\begin{quote}
Die App Winkel-Farm unterstützt die Aneignung des Begriffs »Schenkel« eines Winkels mit dessen Strahl-Eigenschaft, indem sich die Bestandteile des Winkelfeldes ein- und ausblenden lassen sowie vom \emph{Tiermodus} in den \emph{Winkelfeldmodus} gewechselt werden kann und damit das Wesen des Begriffs hervorgehoben werden kann.
\end{quote}

\subsection{Erstaneignung}\label{erstaneignung}

Um die Lernhandlungen zu \emph{verinnerlichen} (genauer: um sie \emph{anzueignen}, was stets als Einheit aus Entäußerung und Verinnerlichung anzusehen ist -- vgl. Abschnitt \ref{taetigkeitstheorie-allgemeine-hinweise}) schlägt Gal'perin eine \textbf{»etappenweise Interiorisierung«} vor (vgl. \citeproc{ref-Lompscher1985a}{Lompscher, 1983, 66~f.}):
...
Besonders bedeutsam sind derartige Verinnerlichungsprozesse für die \emph{elementaren Aneignunghandlungen} \textbf{Identifizieren und Realisieren} (vgl. Abschnitt \ref{lernhandlungen-in-mathe}). Derartige Handlungen sollten also direkter \textbf{Bestandteil der Stofferarbeitung} sein und nicht dem zufälligen Erwerb in anschließenden Übungsphasen überlassen werden.
...
Im Sinne der Typisierung von Lernhandlungen (siehe Abschnitt \ref{lernhandlungen-in-mathe}) bezieht sich dies v.~a. auf \emph{Grundhandlungen} und \emph{komplexe Handlungen}.
...
\section{Bezüge zum Vier-Ebenen-Ansatz}\label{bezuxfcge-zum-vier-ebenen-ansatz}

Der Vier-Ebenen-Ansatz nach Hußmann \& Prediger (\citeproc{ref-Hussmann:2016}{2016}) und die typischen Unterrichtssituationen nach Bruder (\citeproc{ref-Bruder1991}{1991}) entstammen vollkommen unterschiedlichen theoretischen Grundlagen über Mathematikunterricht. Es lohnt sich daher besonders, Bezüge zwischen beiden Theorien herzustellen, um damit die Gestaltung von Lernprozessen anzureichern.
...
\item
  Die \textbf{etappenweise Verinnerlichung von Handlungen} kann dabei unterstützen, \textcolor{semanticColor}{**Grundvorstellungen aufzubauen**}. Das in Abb. \ref{fig:GVverinnerlichen} dargestellte Phasenmodell von Wartha \& Schulz (\citeproc{ref-Wartha2011}{2011, S. 11}) erinnert stark an die etappenweise Verinnerlichung von Lernhandlungen nach Gal'perin. Dabei verwendete \textcolor{semanticColor}{**Darstellungen**} und \textcolor{semanticColor}{**Arbeitsmittel**} können als \textbf{Orientierungshilfe} dienen und unterstützen die Aneignung.
\item
...
Abbildung \ref{fig:Unterrichtsphasen} fasst diese Bezüge noch einmal in einer Übersicht zusammen.
...
In den nächsten Kapitel wird -- aufgeschlüsselt nach Begriffen, Zusammenhängen und Verfahren -- insbesondere dargestellt, wie die Stofferarbeitung und Festigung gestaltet werden können.
...
\chapter{Begriffe}\label{begriffe}
...
\tightlist
\item
  Folien zum Kapitel 7 (\href{files/Stoffdidaktik2025-07-Begriffe.pdf}{pdf}, \href{files/Stoffdidaktik2025-07-Begriffe.key}{Keynote})
\end{itemize}
\end{quote}

\section{Allgemeine Hinweise}\label{allgemeine-hinweise-2}
...
\section{Begriffsklärung}\label{begriffskluxe4rung}
...
\section{Begriffe erarbeiten}\label{begriffe-erarbeiten}

Das Erarbeiten von Begriffen wird auch als \textbf{\emph{Begriffsbildung}} bezeichnet. Die Einführung eines Begriffs kann dabei stets als Wechselspiel zwischen \textbf{Beispielen/Gegenbeispielen} und der \textbf{Begriffsfestlegung} aufgefasst werden. Die Richtung und Qualität dieses Zusammenhangs ermöglicht verschiedene Wege zum Begriff (siehe Abbildung \ref{fig:Begriffseinfuehrung}).
...
\subsection{Ostensive Begriffseinführung}\label{ostensive-begriffseinfuxfchrung}
...
\subsection{Induktive Begriffseinführung}\label{induktive-begriffseinfuxfchrung}
...
\subsection{Deduktive Begriffseinführung}\label{deduktive-begriffseinfuxfchrung}
...
\section{Begriffe aneignen}\label{begriffe-aneignen}
...
\section{Begriffe festigen}\label{begriffe-festigen}

Vertiefende Übungen ergeben sich v.~a. durch die Einordnung des neu erlernten Begriffs in ein \textbf{Begriffssystem}. Hinzu kommt die Verwendung \textbf{alternativer Definitionen} sowie die \textbf{Variabilität in der Verwendung von Bezeichnungen} (z.~B. Variablen). Auch können \textbf{Grenz- und Sonderfälle} des Begriffs diskutiert werden, um ein vertieftes Verständnis zu gewinnen (vgl. \citeproc{ref-Steinhofel1988}{Steinhöfel et al., 1988, S. 34}). Eine systematische Übersicht, auch für ein ähnliches Vorgehen bei Sachverhalten und Verfahren, bietet Tabelle \ref{tab:festigen} in Abschnitt \ref{zusammenfassung-begriffe-zusammenhaenge-verfahren}.
...
\chapter{Zusammenhänge und Verfahren}\label{zusammenhaenger-und-verfahren}
...
\tightlist
\item
  Folien zum Kapitel 8 (\href{files/Stoffdidaktik2025-intern-08-ZusammenhaengeUndVerfahren.pdf}{pdf}, \href{files/Stoffdidaktik2025-intern-08-ZusammenhaengeUndVerfahren.key}{Keynote})
\end{itemize}
\end{quote}

\section{Zusammenhänge erarbeiten}\label{zusammenhuxe4nge-erarbeiten}
...
\subsection{Zusammenhänge finden}\label{zusammenhuxe4nge-finden}
...
\subsection{Begründungen finden}\label{begruxfcndungen-finden}
...
\section{Zusammenhänge aneignen}\label{zusammenhuxe4nge-aneignen}
...
\section{Zusammenhänge festigen}\label{zusammenhuxe4nge-festigen}
...
\section{Allgemeine Hinweise zu Verfahren}\label{allgemeine-hinweise-zu-verfahren}
...
\section{Verfahren erarbeiten}\label{verfahren-erarbeiten}
...
\section{Verfahren aneignen}\label{verfahren-aneignen}
...
\section{Verfahren festigen}\label{verfahren-festigen}
...
\section{Zusammenfassung}\label{zusammenfassung-begriffe-zusammenhaenge-verfahren}
...
\part*{Zusammenführungen}\label{part-zusammenfuxfchrungen}
\addcontentsline{toc}{part}{Zusammenführungen}
...
\tightlist
\item
  Folien zum Kapitel 9 (\href{files/Stoffdidaktik2025-09-ArithmetischesMittel.pdf}{pdf}, \href{files/Stoffdidaktik2025-09-ArithmetischesMittel.key}{Keynote})
\item
  Virtuelles Arbeitsmittel zum Medien und arithmetischen Mittel (\href{files/Stoffdidaktik2025-09-Lagemasse.html}{html}, \href{files/Stoffdidaktik2025-09-Lagemasse.cdy}{Cinderella})
\end{itemize}
\end{quote}

In diesem Kapitel sollen die in den Kapiteln zur Stoffdidaktischen Analyse und zur Gestaltung von Lernprozessen dargestellten Theorien auf die Planung einer 45-minütigen Unterrichtsstunde zum arithmetischen Mittel angewandt werden. Es handelt sich dabei nicht um eine ausführliche Unterrichtsplanung -- für diese wäre mindestens noch eine Bedingungsanalyse der zu unterrichtenden Klasse und eine ausführlichere didaktisch-methodische Diskussion notwendig. Vielmehr soll \emph{im Groben} dargestellt werden, welche theoriebasierten Gedankengänge in die Strukturierung einer Unterrichtsstunde fließen können.
...
\subsection{Stofferarbeitung}\label{stofferarbeitung-1}
...
\item
  Die in der Definition enthaltene Vorgehensbeschreibung kann als \textbf{Orientierungshilfe} angesehen werden, um den Begriff des arithmetischen Mittels zu realisieren (vgl. Abschnitte \ref{orientierungshilfen} und \ref{begriffe-aneignen}).\\
\item
...
Zur Festigung des arithmetischen Mittels bietet es sich an, \textbf{Aufgaben vielfältig zu variieren} (vgl. Abschnitt \ref{begriffe-festigen}) und nach dem operativen Prinzip durchzuarbeiten.
...
Sollte bereits andere Lagemaße behandelt worden sein, so bietet sich in einer Festigung auch immer ein Vergleich zwischen den Lagemaßen an. Das in Abbildung \ref{fig:ScreenshotLagemass} dargestellte \href{files/Stoffdidaktik2025-B-Lagemasse.html}{virtuelle Arbeitsmittel} ermöglicht bspw. einen \textbf{Vergleich zwischen Median und arithmetischem Mittel}.
...
{\centering \includegraphics[width=0.95\linewidth]{pictures/A-SammlungLernbereiche} 

}

\caption{Sammlung von Lernbereichen}\label{fig:Lernbereiche}
\end{figure}

Die Übersicht kann als \href{files/Stoffdidaktik2025-SammlungLernbereiche.pdf}{pdf-Datei} heruntergeladen werden.

\chapter{Orientierungshilfen für Lehrhandlungen}\label{orientierungshilfen-fuer-lernhandlungen}
...
Die Übersicht kann als \href{files/Stoffdidaktik2025-Orientierungshilfe-FormaleEbene.pdf}{pdf-Datei} heruntergeladen werden.
...
Die Übersicht kann als \href{files/Stoffdidaktik2025-Orientierungshilfe-Kernideen.pdf}{pdf-Datei} heruntergeladen werden.

\section{Motivierung und Zielbildung}\label{orientierungshilfe-motivierung-zielbildung}
...
\caption{Orientierungshilfe zur Gestaltung der Motivierung und Zielbildung}\label{fig:OrientierungAusloesen}
\end{figure}

Die Übersicht kann als \href{files/Stoffdidaktik2025-Orientierungshilfe-MotivierungZielbildung.pdf}{pdf-Datei} heruntergeladen werden.
...
\chapter{Vollständiges Literaturverzeichnis}\label{vollstaendiges-literaturverzeichnis}
...
\bibitem[\citeproctext]{ref-Bruder2015b}
Bruder, R., Feldt-Caesar, N., Pallack, A., Pinkernell, G., \& Wynands, A. (2015). Mathematisches {Grundwissen} und {Grundkönnen} in der {Sekundarstufe} {II}. In W. Blum, S. Vogel, C. Drüke-Noe, \& A. Roppelt (Hrsg.), \emph{Bildungsstandards aktuell: {Mathematik} in der {Sekundarstufe} {II}} (S. 108--124). Schroedel.
...
\bibitem[\citeproctext]{ref-Gunster2020}
Günster, S. M., \& Ruppert, M. (2020). Das {Operative} {Prinzip}. \emph{mathematik lehren}, \emph{223}, 22--26.
...
\bibitem[\citeproctext]{ref-Heitzer2020a}
Heitzer, J., \& Weigand, H.-G. (2020). Mathematikdidaktische {Prinzipien}. \emph{mathematik lehren}, \emph{223}, 2--7.
...
\bibitem[\citeproctext]{ref-Hoffkamp2024}
Hoffkamp, A., \& Lensing, F. (Hrsg.). (2024). \emph{mathematik lehren 246: {Permanenzprinzip}}. Friedrich Verlag.
...
\bibitem[\citeproctext]{ref-Salle2023}
Salle, A., Schmidt-Thieme, B., Schulz, A., \& Söbbeke, E. (2023). Darstellen und {Darstellungen} verwenden. In R. Bruder, A. Büchter, H. Gasteiger, B. Schmidt-Thieme, \& H.-G. Weigand (Hrsg.), \emph{Handbuch der {Mathematikdidaktik}} (S. 429--461). Springer Berlin Heidelberg. \url{https://doi.org/10.1007/978-3-662-66604-3_14}
...
\bibitem[\citeproctext]{ref-Zais2003}
Zais, T. (2003). Der {Beitrag} des {Wissenschaftsbereichs} "{Methodik} des {Mathematikunterrichts}" der {Universität} {Karl}-{Marx}-{Stadt} zur mathematikmethodischen {Theoriebildung} in der {DDR}. In H. Henning \& P. Bender (Hrsg.), \emph{Didaktik der {Mathematik} in den alten {Bundesländern} --- {Methodik} des {Mathematikunterrichts} in der {DDR}. {Bericht} über eine {Doppeltagung} zur gemeinsamen {Aufarbeitung} einer getrennten {Geschichte}} (S. 246--256). \url{http://www.math.uni-magdeburg.de/private/henning/tagung.pdf}
