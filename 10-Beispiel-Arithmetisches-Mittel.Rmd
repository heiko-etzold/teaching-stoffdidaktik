...
# (PART\*) Zusammenführungen {.unnumbered}
...
> **Material**
>
> + Folien zum Kapitel 9 ([pdf](files/Stoffdidaktik2025-09-ArithmetischesMittel.pdf), [Keynote](files/Stoffdidaktik2025-09-ArithmetischesMittel.key))
> + Virtuelles Arbeitsmittel zum Medien und arithmetischen Mittel ([html](files/Stoffdidaktik2025-09-Lagemasse.html), [Cinderella](files/Stoffdidaktik2025-09-Lagemasse.cdy))
...
* Die in der Definition enthaltene Vorgehensbeschreibung kann als **Orientierungshilfe** angesehen werden, um den Begriff des arithmetischen Mittels zu realisieren (vgl. Abschnitte \@ref(orientierungshilfen) und \@ref(begriffe-aneignen)).  
...
Zur Festigung des arithmetischen Mittels bietet es sich an, **Aufgaben vielfältig zu variieren** (vgl. Abschnitt \@ref(begriffe-festigen)) und nach dem operativen Prinzip durchzuarbeiten.
...
Sollte bereits andere Lagemaße behandelt worden sein, so bietet sich in einer Festigung auch immer ein Vergleich zwischen den Lagemaßen an. Das in Abbildung \@ref(fig:ScreenshotLagemass) dargestellte [virtuelle Arbeitsmittel](files/Stoffdidaktik2025-B-Lagemasse.html) ermöglicht bspw. einen **Vergleich zwischen Median und arithmetischem Mittel**.
