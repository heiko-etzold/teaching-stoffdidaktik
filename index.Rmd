...
Ausgenommen von der CC-BY-SA-Lizenz sind insbesondere die Abbildungen \@ref(fig:FreudenthalWinkel), \@ref(fig:FreudenthalWinkelSpiegeln), \@ref(fig:GVverinnerlichen), \@ref(fig:Tiergehege), \@ref(fig:FlaecheEinheiten), \@ref(fig:Etappen), \@ref(fig:Musterfolge), \@ref(fig:Grenzwert), \@ref(fig:Mittelsenkrechte), \@ref(fig:Modelle) und \@ref(fig:Prozessbetrachtung) -- diese werden im Sinne des Zitaterechts ([§ 51 UrhG](https://www.gesetze-im-internet.de/urhg/__51.html)) verwendet.
