...
> **Material**
>
> + Folien zum Kapitel 2 ([pdf](files/Stoffdidaktik2025-02-HochSchulmathematikStrukturieren.pdf), [Keynote](files/Stoffdidaktik2025-02-HochSchulmathematikStrukturieren.key))
...
Im Rahmen der Stoffdidaktik-Veranstaltung sollen beide Ansätze aufgegriffen und an konkreten Beispielen versucht werden, die Fragen der `r formal("formalen Ebene")` zu beantworten. 
...
Für eine Vertiefung mit der Didaktik der Sachgebiete eignen sich u. a. die in Abschnitt \@ref(geeignete-quellen) dargestellten Quellen. Weiterhin werden Sie im Masterstudium im Modul *Ausgewählte Themen der Mathematikdidaktik*^[siehe Modulbeschreibung zum Modul [MAT-LS-D3 bei PULS](https://puls-qis.uni-potsdam.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=modulansicht&publishConfFile=modulverwaltung&publishSubDir=up/modulbearbeiter&&modul.modul_id=3186&menuid=&topitem=&subitem=)] die Möglichkeit haben, sich mit der Didaktik einzelner Sachgebiete näher auseinanderzusetzen.
...
Einige Autoren zählen zu den Verfahren auch heuristische Strategien zum Problemlösen oder die Anwendung des Permanenzprinzips [vgl. @Steinhofel1988,23]. @Vollrath2012 [46 ff.] ergänzen inhaltlich ähnlich:
...
In den nächsten Kapiteln <!--Abschnitt \@ref(begriffe-sachverhalte-verfahren)-->wird näher darauf eingegangen, wie Lernprozesse bei der Ausbildung der jeweiligen Stoffelement-Kategorien gestaltet werden können.
...
Weitere Hinweise zum Einsatz des Permanenzprinzips im Mathematikunterricht finden Sie zum Beispiel bei @Hoffkamp2024.
