---
title: "Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2025/26"
description: "Vorlesungsskript zur Stoffdidaktik Mathematik im Wintersemester 2025/26 an der Universität Potsdam bei Dr. Heiko Etzold"
  ...
  bookdown::gitbook:
    ...
    config:
      toc:
        ...
        before: 
          <li><a href="index.html"><b>Stoffdidaktik Mathematik 2025/26</b></a></li>
        after:
...
url: "stoffdidaktik.heiko-etzold.de/2025/"
---

# Über dieses Dokument {#index -}
...
> Etzold, H. (`r format(Sys.time(), '%Y')`). *Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2025/26* (Version vom `r format(Sys.time(), '%d.%m.%Y')`). https://stoffdidaktik.heiko-etzold.de/2025

Die Vorlesungsskripte der letztjährigen Veranstaltungen finden Sie unter:

- https://stoffdidaktik.heiko-etzold.de/2024
