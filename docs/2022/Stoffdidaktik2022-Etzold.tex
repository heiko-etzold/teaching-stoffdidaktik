...
\date{Letzte Änderung: 22.06.2023}
...
\begin{quote}
Etzold, H. (2023). \emph{Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2022/23}. \url{https://stoffdidaktik.heiko-etzold.de/2022}
\end{quote}
...
\tightlist
\item
  Lesen Sie das Kapitel 3.2.2 \emph{Der Begriff der Fundamentalen Ideen in der Pädagogik} bei Schubert \& Schwill (\protect\hyperlink{ref-Schubert:2011}{2011, 59--65}).
\item
...
Unabhängig von konkreten Lerngegenständen haben Bruder \& Brückner (\protect\hyperlink{ref-Bruder1989}{1989}) typische Lernhandlungen für den Mathematikunterricht strukturiert beschrieben (Hervorhebungen im Original, auch dargestellt bei \protect\hyperlink{ref-Feldt-Caesar2017}{Feldt-Caesar, 2017, 87~ff.}):
...
Nach dem Orientierungsteil kommt es zum Ausführungsteil der Lernhandlungen. Hierfür schlägt Gal'perin eine »etappenweise Interiorisierung« von Lernhandlungen vor (vgl. \protect\hyperlink{ref-Lompscher1983a}{Lompscher, 1983a, 66~f.}):
...
Am Beispiel der App \emph{Klipp Klapp} (\protect\hyperlink{ref-Etzold2020a}{Etzold, 2020}) stellt Stein (\protect\hyperlink{ref-Stein2018}{2018}) eine entsprechende Analyse dar, die englischsprachige Übersetzung ist bei Larkin et al. (\protect\hyperlink{ref-Larkin2019}{2019, 85~ff.}) zu finden.
...
Leuders (\protect\hyperlink{ref-Leuders2009}{2009, 137~ff.}) stellt in einer ausführlichen Tabelle (am Beispiel des arithmetischen Mittels) dar, wie man sich ausgehend vom gewünschten Fähigkeitsaspekt (z.~B. »Strukturen reflektieren«) und damit zusammenhängenden Aufgabentypen (z.~B. »Muster erkennen und erzeugen«) an geeigneten Fragetypen (z.~B.»Muster fortsetzen«) orientieren kann, um einen produktiven Umgang mit Aufgaben zu ermöglichen. Mit diesem Hintergrundwissen können Sie Ihren Blick auf existierende Schulbuchaufgaben richten und diese dann zielgerichtet anpassen.
...
Aus diesen Materialien sowie den Beschreibungen in den Bildungsstandards für die Sekundarstufen (\protect\hyperlink{ref-KMK:2012}{Sekretariat der Ständigen Konferenz der Kultusminister der Länder in der Bundesrepublik Deutschland, 2012, 18}; \protect\hyperlink{ref-SekretariatderStandigenKonferenzderKultusministerderLanderinderBundesrepublikDeutschland2022}{2022a, 15~f.}) lassen sich einige bedeutsame Lerngegenstände ableiten:
...
Angelehnt an die \emph{Mathewerkstatt} für die Klassenstufe 9 (\protect\hyperlink{ref-Barzel2016}{Barzel et al., 2016, 92~ff.}) sowie die Überlegungen in den Kapiteln \ref{lerntaetigkeit-und-lernhandlungen} und \ref{arbeitsmittel-begriffsklaerung}, bietet sich folgende Einführung des Wurzelbegriffs an:
...
Aus diesen Materialien sowie den Beschreibungen in den Bildungsstandards für die Sekundarstufen (\protect\hyperlink{ref-KMK:2012}{Sekretariat der Ständigen Konferenz der Kultusminister der Länder in der Bundesrepublik Deutschland, 2012, 19}; \protect\hyperlink{ref-SekretariatderStandigenKonferenzderKultusministerderLanderinderBundesrepublikDeutschland2022}{2022a, 17~f.}) lassen sich folgende bedeutsame Lerngegenstände ableiten:
...
Das \textbf{Geodreieck} ist insofern problematisch, als dass seine (unkritische) Verwendung zu einer Verwechslung von Winkelgrößen und Streckenlängen führen kann. In einer Studie von Dohrmann \& Kuzle (\protect\hyperlink{ref-Dohrmann2014}{2014, 303 f.}) haben etwa 10~\% der Schülerinnen und Schüler die Vorstellung geäußert, \(1°\) sei so groß wie \(1\,\mathrm{mm}\). Wendet man die im Abschnitt \ref{analyseschritte} dargestellten Schritte zur Analyse eines Arbeitsmittels hierauf an, wäre für diese Fehlvorstellung ein tätigkeitstheoretischer Erklärungsansatz, dass sowohl beim Messen eines Winkels als auch beim Messen einer Strecken dieselbe \emph{Operation} mit demselben \emph{Arbeitsmittel} durchgeführt wird (nämlich das Ablesen der Skala am geradlinig verlaufenden Rand des Geodreiecks, siehe Abbildung \ref{fig:Geodreieck}). Damit verbinden die Schülerinnen (fälschlicherweise) dieselbe mathematische Handlung, sehen also das Winkelmessen als dasselbe an wie das ihnen bereits bekannte Streckenmessen (vgl. auch \protect\hyperlink{ref-Dohrmann2018b}{Dohrmann \& Etzold, 2018, 450 f.}).
...
\caption{Konzeptbild zur Leitidee \emph{Raum und Form} (\protect\hyperlink{ref-LISUM2022}{LISUM, 2022, 23})}\label{fig:KonzeptRaumForm}
\end{figure}

Mit den Beschreibungen in den Bildungsstandards für die Sekundarstufen (\protect\hyperlink{ref-KMK:2012}{Sekretariat der Ständigen Konferenz der Kultusminister der Länder in der Bundesrepublik Deutschland, 2012, 19}; \protect\hyperlink{ref-SekretariatderStandigenKonferenzderKultusministerderLanderinderBundesrepublikDeutschland2022}{2022a, 20~f.}) ergeben sich folgende bedeutsame Lerngegenstände:
...
Daraus sowie mit den Beschreibungen in den Bildungsstandards für die Sekundarstufen (\protect\hyperlink{ref-KMK:2012}{Sekretariat der Ständigen Konferenz der Kultusminister der Länder in der Bundesrepublik Deutschland, 2012, 20}; \protect\hyperlink{ref-SekretariatderStandigenKonferenzderKultusministerderLanderinderBundesrepublikDeutschland2022}{2022a, 18~f.}) können folgende Lerngegenstände als bedeutsam angesehen werden:
...
Gemäß der in Kapitel \ref{grundvorstellungen} eingeführten Bezeichnungen können zu drei Grundvorstellungen des Variablenbegriffs Aspekte formuliert werden, hier entnommen aus Weigand et al. (\protect\hyperlink{ref-Weigand2022}{2022, 35~f.})
...
Aus den Beschreibungen in den Bildungsstandards für die Sekundarstufen (\protect\hyperlink{ref-KMK:2012}{Sekretariat der Ständigen Konferenz der Kultusminister der Länder in der Bundesrepublik Deutschland, 2012, 21}; \protect\hyperlink{ref-SekretariatderStandigenKonferenzderKultusministerderLanderinderBundesrepublikDeutschland2022}{2022a, 22~f.}) lassen sich folgende bedeutsamen Lerngegenstände folgern:
...
Bruder, R. (2023). Orientierungsgrundlagen der {Lerntätigkeit} nach {Lompscher} -- {Potenziale} und {Einordnung} eines theoretischen {Konzepts}. In I.-P. G.-U. Frankfurt (Hrsg.), \emph{Beiträge zum {Mathematikunterricht} 2022. 56. {Jahrestagung} der {Gesellschaft} für {Didaktik} der {Mathematik}}. WTM. \url{https://doi.org/10.17877/DE290R-23484}
...
\leavevmode\vadjust pre{\hypertarget{ref-Buchter2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Dohrmann2018}{}}%
Dohrmann, C. (2018). Herausforderungen bei der {Winkelmessung}. \emph{mathematik lehren}, \emph{210}, 20--23.

\leavevmode\vadjust pre{\hypertarget{ref-Dohrmann2018b}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Dohrmann2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Fabian2022}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Filler2011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Freudenthal1989}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Hussmann2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-LISUM2022}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-MinisteriumfurBildungJugendundSportdesLandesBrandenburg2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Schulz2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Sill2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dewiki:225284496}{}}%
