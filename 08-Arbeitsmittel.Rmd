...
> **Material**
>
> + Folien zum Kapitel 8 ([pdf](files/Stoffdidaktik2024-08-Arbeitsmittel.pdf), [Keynote](files/Stoffdidaktik2024-08-Arbeitsmittel.key))
...
In Abschnitt \@ref(vermittelnde-werkzeuge) wurde bereits beschrieben, dass in der Tätigkeitstheorie *vermittelnde Werkzeuge* bedeutsam sind in der Auseinandersetzung eines Individuums mit einem Lerngegenstand. Derartige ***Lernmittel*** können, wie im entsprechenden Abschnitt beschrieben, vielfältiger Natur sein (z. B. Zirkel und Lineal als Hilfsmittel, Gesten, Sprache, Abbildungen und Skizzen, … ).
...
Bei der Auswahl (oder Entwicklung) eines Arbeitsmittels ist es für Sie als Lehrkraft daher von besonderer Bedeutung, was der *Kern* des entsprechenden mathematischen Gegenstands ist. Hierfür ist es notwendig, dass also das **Arbeitsmittel mit der `r concrete("Kernidee")` des Lerngegenstands in Einklang** steht. Bezugnehmend auf die **`r semantic("Grundvorstellungsidee")`** ermöglicht das Arbeitsmittel nun auch **operatives Handeln in Bezug auf (visuelle) Repräsentationen** und unterstützt damit auch den zweiten Aspekt von Definiton  \@ref(def:Grundvorstellungen).
...
knitr::include_graphics("pictures/8-Waage.png")
```
...
knitr::include_graphics("pictures/8-Streichholz.png")
```
...
knitr::include_graphics("pictures/8-Pfeile.png")
```
...
knitr::include_graphics("pictures/8-negativePfeile.png")
```
...
knitr::include_graphics("pictures/8-dynamischePfeile.gif")
```
