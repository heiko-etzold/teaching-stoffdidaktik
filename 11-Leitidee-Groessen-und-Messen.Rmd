...
Im nächsten Schritt werden Winkel mithilfe von Vergleichswinkeln ausgelegt. Hierzu bieten sich **gleich große Winkelkeile** an. Dies ermöglicht nun eine erste Quantifizierung, ähnlich wie bei Flächeninhalt mit bekannten Vergleichmaßen (z. B. Fußballfelder) argumentiert wird. Abbildung \@ref(fig:Winkelauslegen) zeigt ein derartiges Auslegen.
