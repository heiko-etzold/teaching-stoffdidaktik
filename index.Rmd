...
Ausgenommen von der CC-BY-SA-Lizenz sind insbesondere die Abbildungen \@ref(fig:FreudenthalWinkel), \@ref(fig:FreudenthalWinkelSpiegeln), \@ref(fig:GVverinnerlichen), \@ref(fig:Tiergehege), \@ref(fig:FlaecheEinheiten) und \@ref(fig:Etappen)<!-- , \@ref(fig:Etappen), \@ref(fig:ACAT) und \@ref(fig:ProzentErkunden) bis \@ref(fig:Schwierig), \@ref(fig:Mittelsenkrechte) bis \@ref(fig:InnenwinkelReissen), \@ref(fig:ThalesBeweis) und \@ref(fig:DefinitionZufallsexperiment) bis \@ref(fig:Prozessbetrachtung)--> -- diese werden im Sinne des Zitaterechts ([§ 51 UrhG](https://www.gesetze-im-internet.de/urhg/__51.html)) verwendet.
