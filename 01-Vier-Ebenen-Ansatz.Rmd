...
## Analyse von Lernbereichen

Die inhaltliche Basis der Veranstaltung bietet ein Beitrag von @Hussmann:2016 zur Spezifizierung und Strukturierung mathematischer Lernbereiche^[In der Originalquelle wird von *Lerngegenständen* statt von *Lernbereichen* gesprochen. Abschnitt \@ref(lernbereich-und-lerngegenstand)]. Nur einen Artikel als Basis einer kompletten 4 SWS starken Veranstaltung zu nutzen, scheint zunächst unüblich. In diesem Fall ist es jedoch hilfreich, da der Beitrag eine Kategorisierung stoffdidaktischer Analysen vorschlägt und vielfältige Fragen formuliert, woraus sich wieder ein ganzes Repertoir an Themen ergibt, die es im Rahmen von Vorlesung und Seminar zu untersuchen gilt.
...
Zu Lerngegenständen gehören -- im Rahmen des Mathematikunterrichts -- sowohl **inhaltliche Themen** (wie der *Satz des Pythagoras*, *Rechnen mit negativen Zahlen*, …) als auch **typische Methoden und Vorgehensweisen** (wie das *Modellieren*, *Problemlösen*), aber auch **Werte und Normen**, die vermittelt werden sollen (z. B. dass in Rechnungen das *Gleichheitszeichen untereinander* geschrieben wird, handschriftliche Zeichnungen *mit einem gespitzen Bleistift anzufertigen* sind usw.). 

Im Rahmen der Stoffdidaktik-Veranstaltung wird sich auf inhaltliche Themen konzentriert. Aber auch hier gibt es eine Fülle und potenzielle Kleinteiligkeit: So kann etwa das *Einzeichnen einer gebrochenen Zahl auf dem Zahlenstrahl* als eigener Lerngegenstand aufgefasst werden, aber auch die gesamte *Bruchrechnung* ist ein Lerngegenstand. Es bietet sich daher an, größere Cluster zu schaffen, die eines vergleichbaren Aufwands für die stoffdidaktische Analyse benötigen. Solche Cluster von Lerngegenständen sollen als ***Lernbereiche*** bezeichnet werden. Üblicherweise spiegelt sich ein Lernbereich dann in einer **Unterrichtssequenz** wieder [vgl. auch @Vollrath2012 187].
