...
\date{Letzte Änderung: 26.01.2023}
...
\begin{quote}
Etzold, H. (2023). \emph{Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2022/23} (Version vom 26.01.2023). \url{https://stoffdidaktik.heiko-etzold.de}
\end{quote}
...
Gemäß der in Kapitel \ref{grundvorstellungen} eingeführten Bezeichnungen können zu drei Grundvorstellungen des Variablenbegriffs Aspekte formuliert werden, hier wörtlich entnommen aus Weigand et al. (\protect\hyperlink{ref-Weigand2022}{2022, S. 35~f.})
