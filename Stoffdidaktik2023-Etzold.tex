...
\date{Letzte Änderung: 10.02.2024}
...
\begin{quote}
Etzold, H. (2024). \emph{Stoffdidaktik Mathematik -- Skript zur Vorlesung im Wintersemester 2023/24} (Version vom 10.02.2024). \url{https://stoffdidaktik.heiko-etzold.de}
\end{quote}
...
Ausgenommen von der CC-BY-SA-Lizenz sind insbesondere die Abbildungen \ref{fig:FreudenthalWinkel}, \ref{fig:FreudenthalWinkelSpiegeln}, \ref{fig:GVverinnerlichen}, \ref{fig:Tiergehege}, \ref{fig:FlaecheEinheiten}, \ref{fig:Etappen}, \ref{fig:Musterfolge}, \ref{fig:Grenzwert}, \ref{fig:Mittelsenkrechte}, \ref{fig:Modelle} und \ref{fig:Prozessbetrachtung} -- diese werden im Sinne des Zitaterechts (\href{https://www.gesetze-im-internet.de/urhg/__51.html}{§~51 UrhG}) verwendet.
...
\hypertarget{analyse-von-lernbereichen}{%
\section{Analyse von Lernbereichen}\label{analyse-von-lernbereichen}}

Die inhaltliche Basis der Veranstaltung bietet ein Beitrag von Hußmann \& Prediger (\protect\hyperlink{ref-Hussmann:2016}{2016}) zur Spezifizierung und Strukturierung mathematischer Lernbereiche\footnote{In der Originalquelle wird von \emph{Lerngegenständen} statt von \emph{Lernbereichen} gesprochen. Abschnitt \ref{lernbereich-und-lerngegenstand}}. Nur einen Artikel als Basis einer kompletten 4~SWS starken Veranstaltung zu nutzen, scheint zunächst unüblich. In diesem Fall ist es jedoch hilfreich, da der Beitrag eine Kategorisierung stoffdidaktischer Analysen vorschlägt und vielfältige Fragen formuliert, woraus sich wieder ein ganzes Repertoir an Themen ergibt, die es im Rahmen von Vorlesung und Seminar zu untersuchen gilt.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{\textcolor{formalColor}{Formale Ebene}} & \textbf{Welche Begriffe, Sachverhalte und Verfahren} sollen erarbeitet werden? Wie können die Sachverhalte und Verfahren \textbf{formal begründet} werden? & Wie kann das \textbf{Netzwerk} aus Begriffen, Sachverhalten und Verfahren \textbf{logisch strukturiert} werden? Welche \textbf{Verbindungen} zwischen den Fachinhalten sind aus fachlicher Perspektive entscheidend, welche weniger? \\
\textbf{\textcolor{semanticColor}{Semantische Ebene}} & \textbf{Welche} (mathematisch-gesellschaftliche) \textbf{Bedeutung} liegt hinter dem Lerngegenstand (vgl. \protect\hyperlink{fundamentale-ideen}{\emph{Fundamentale Ideen}})? \textbf{Welcher Sinn} soll bei den Schülerinnen und Schülern hinsichtlich des Lerngegenstands aufgedeckt werden und \textbf{welche Repräsentationen} sind dafür geeignet (vgl. \protect\hyperlink{grundvorstellungen}{\emph{Grundvorstellungen}})? & Wie \textbf{verhalten} sich Sinn und Bedeutung des Lerngegenstands \textbf{zueinander} und \textbf{zu früheren und späteren Lerngegenständen}? \\
\textbf{\textcolor{concreteColor}{Konkrete Ebene}} & \textbf{Welche \protect\hyperlink{kernidee-begriffsklaerung}{Kernfragen und Kernideen}} können die Entwicklung der Begriffe, Sachverhalte und Verfahren leiten? \textbf{Welche} (inner- und außermathematischen) \textbf{\protect\hyperlink{kontexte-begriffsklaerung}{Kontexte}} sind geeignet, um an ihnen die Kernfragen und -ideen exemplarisch zu behandeln und die Inhalte zu rekonstruieren? & Wie kann das Verständnis sukzessive \textbf{über realitätsbezogene Situationen} in dem beabsichtigten Lernpfad konstruiert werden (vgl. \protect\hyperlink{mathematisierungstypen}{\emph{horizontale Mathematisierung}})? Wie kann der Lernpfad \textbf{in Bezug auf die mathematische Problemstruktur} angeordnet werden (vgl. \protect\hyperlink{mathematisierungstypen}{\emph{vertikale Mathematisierung}})? \\
...
Diese Fragen können dabei helfen, einen Lernbereich aus professioneller Sicht vollumfänglich zu analysieren (insb. Spezifizierung) und daraus die Gestaltung eines Lernpfades für Schülerinnen und Schüler abzuleiten (insb. Strukturierung). Noch \emph{nicht} abgeleitet werden kann daraus jedoch die Gestaltung einer \emph{konkreten Unterrichtsstunde} -- dies bedarf weiterer Überlegungen, z.~B. zu Unterrichtsmethoden, Aufgaben, Klassenmanagement, \ldots{} (\protect\hyperlink{ref-Hussmann:2016}{Hußmann \& Prediger, 2016, S. 37}).

\hypertarget{lernbereich-und-lerngegenstand}{%
...
Zu Lerngegenständen gehören -- im Rahmen des Mathematikunterrichts -- sowohl \textbf{inhaltliche Themen} (wie der \emph{Satz des Pythagoras}, \emph{Rechnen mit negativen Zahlen}, \ldots) als auch \textbf{typische Methoden und Vorgehensweisen} (wie das \emph{Modellieren}, \emph{Problemlösen}), aber auch \textbf{Werte und Normen}, die vermittelt werden sollen (z.~B. dass in Rechnungen das \emph{Gleichheitszeichen untereinander} geschrieben wird, handschriftliche Zeichnungen \emph{mit einem gespitzen Bleistift anzufertigen} sind usw.).

Im Rahmen der Stoffdidaktik-Veranstaltung wird sich auf inhaltliche Themen konzentriert. Aber auch hier gibt es eine Fülle und potenzielle Kleinteiligkeit: So kann etwa das \emph{Einzeichnen einer gebrochenen Zahl auf dem Zahlenstrahl} als eigener Lerngegenstand aufgefasst werden, aber auch die gesamte \emph{Bruchrechnung} ist ein Lerngegenstand. Es bietet sich daher an, größere Cluster zu schaffen, die eines vergleichbaren Aufwands für die stoffdidaktische Analyse benötigen. Solche Cluster von Lerngegenständen sollen als \textbf{\emph{Lernbereiche}} bezeichnet werden. Üblicherweise spiegelt sich ein Lernbereich dann in einer \textbf{Unterrichtssequenz} wieder (vgl. auch \protect\hyperlink{ref-Vollrath2012}{Vollrath \& Roth, 2012, S. 187}).
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/5-dynamischePfeile} 

}

\caption{Gleichheit/Ungleichheit der Terme $2x+1$ und $7$ im Pfeil-Modell}\label{fig:dynamischePfeile}
\end{figure}
...
\hypertarget{kernideen-und-kontexte}{%
...
\tightlist
\item
  Folien zum Kapitel 6 (\href{files/Stoffdidaktik2023-06-KernideenUndKontexte.pdf}{pdf}, \href{files/Stoffdidaktik2023-06-KernideenUndKontexte.key}{Keynote})
\end{itemize}
\end{quote}
...
Kernideen/Kernfragen und der sinnstiftende Kontext bilden damit eine Einheit in der \textbf{Motivierung und Zielbildung} zu Beginn der Auseinandersetzung mit einem Lerngegenstand, siehe auch Abschnitt \ref{motivierung-und-zielbildung}.
...
\hypertarget{kernideen-kontexte-nachbereitung}{%
...
\hypertarget{intermezzo-flaecheninhalt}{%
\chapter{Intermezzo: Flächeninhalt}\label{intermezzo-flaecheninhalt}}
...
\tightlist
\item
  Folien zum Kapitel 7 (\href{files/Stoffdidaktik2023-07-Intermezzo.pdf}{pdf}, \href{files/Stoffdidaktik2023-07-Intermezzo.key}{Keynote})
\end{itemize}
\end{quote}
...
In dem Schulbuch \emph{Mathewerkstatt} (\protect\hyperlink{ref-Barzel2012}{Barzel et al., 2012c}) wird der Flächeninhalt über den Kontext von Tiergehegen eingeführt (siehe Abbildung \ref{fig:Tiergehege}). So haben in einem Zoo verschiedene Tiere unterschiedlich große Gehe zur Verfügung. Die Form der Gehege variiert dabei ebenfalls.



\begin{figure}

{\centering \includegraphics[width=1\linewidth]{pictures/7-Tiergehege} 

}

\caption{Einstiegsbild zum Thema Flächeninhalt (\protect\hyperlink{ref-Barzel2012}{Barzel et al., 2012c, 168~f.})}\label{fig:Tiergehege}
\end{figure}
...
All diese Überlegungen kommen zunächst \textbf{ohne Formeln} aus, weshalb Formeln im Unterricht auch erst im Anschluss an eine inhaltliche Erarbeitung des Flächeninhaltsbegriffs eingeführt und genutzt werden sollten.
...
Interessant ist hier auch die \textbf{\emph{Willkürlichkeit} des Vergleichsmaßes}. Kulturell geprägt ist (in Kontinentaleuropa) zwar beispielsweise 1~cm2, aber auch andere Einheiten sind gleichberechtigt möglich. Auch muss das Vergleichsmaß nicht zwingend ein Quadrat sein. Nicht selten wird z.~B. von großen Flächen angegeben, wie viele Fußballfelder in sie hineinpassen würden. Für den Unterricht bedeutet das, dass im Sinne einer auf den mathematischen Kern orientierten Sichtweise zunächst möglichst allgemeine und vielfältige (auch \emph{unförmige}) Vergleichsflächen herangezogen werden können. Später ist dann natürlich ein Bezug zu den Standardeinheiten herzustellen (siehe Abbildung \ref{fig:FlaecheEinheiten}).



\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{pictures/7-Einheiten} 
...
\begin{quote}
Welche (mathematisch-gesellschaftliche) Bedeutung liegt hinter dem Lerngegenstand (vgl. \emph{Fundamentale Ideen}?\\
Welcher Sinn soll bei den Schülerinnen und Schülern hinsichtlich des Lerngegenstands aufgedeckt werden und welche Repräsentationen sind dafür geeignet (vgl. \emph{Grundvorstellungen}?\\
...
{\centering \includegraphics[width=0.25\linewidth]{pictures/7-Masszahl} 
...
{\centering \includegraphics[width=0.25\linewidth]{pictures/7-abb-Vereinigung} 
...
{\centering \includegraphics[width=0.25\linewidth]{pictures/7-Kongruenz} 
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/7-abb-Kreis} 
...
Wie kann das Verständnis sukzessive über realitätsbezogene Situationen in dem beabsichtigten Lernpfad konstruiert werden (vgl. \emph{horizontale Mathematisierung})?\\
Wie kann der Lernpfad in Bezug auf die mathematische Problemstruktur angeordnet werden (vgl. \emph{vertikale Mathematisierung})?
\end{quote}
...
Dabei werden zwei \textbf{Kernideen} aufgegriffen (\protect\hyperlink{ref-Barzel2012a}{Barzel et al., 2012a, 359~f.}):
...
Kuntze (\protect\hyperlink{ref-Kuntze2018}{2018, 159~f.}) verweist auf typische Schwierigkeiten von Schülerinnen und Schülern im Umgang mit dem Flächeninhaltsbegriff.
...
\hypertarget{intermezzo-nachbereitung}{%
\section{Zum Nachbereiten}\label{intermezzo-nachbereitung}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Finden Sie einen alternativen Kontext (statt den Zoogehegen) für Flächeninhalte, der die Forderungen nach Sinnstiftung erfüllt (siehe Definition \ref{def:Kontext}).
\item
...
\chapter{Tätigkeitstheorie und Lernen}\label{taetigkeitstheorie-und-lernen}}
...
\tightlist
\item
  Folien zum Kapitel 8 (\href{files/Stoffdidaktik2023-08-TaetigkeitstheorieUndLernen.pdf}{pdf}, \href{files/Stoffdidaktik2023-08-TaetigkeitstheorieUndLernen.key}{Keynote})
\end{itemize}
\end{quote}

\hypertarget{lerntaetigkeit-und-lernhandlung}{%
...
Im Rahmen der \emph{Lerntätigkeit} führt dies dann zu \textbf{\emph{Lernhandlungen}}. Lompscher (\protect\hyperlink{ref-Lompscher1985b}{1985, S. 46}) definiert:
...
\hypertarget{motivierung-und-zielbildung}{%
\section{Motivierung und Zielbildung}\label{motivierung-und-zielbildung}}

Die obigen Überlegungen zeigen, dass die \textbf{Motivierung und Zielbildung} bedeutsame Bestandteile eines Lernprozesses sind, sich also in der Gestaltung konkreter Unterrichtssituationen widerspiegeln müssen -- durch entsprechende Phasen innerhalb einer Unterrichtsstunde. Erst wenn Motive und Ziele ausgeprägt sind, kann es in weiteren Unterrichtsphasen zur \textbf{Ausbildung der Lernhandlungen} kommen (siehe auch Abbildung \ref{fig:Unterrichtsphasen}).

\hypertarget{zone-der-nuxe4chsten-entwicklung}{%
...
Nach der Motivierung und Zielbildung folgt nun die (wie auch immer geartete) Erarbeitung des neuen Lerngegenstands. Spezifische Möglichkeiten hierfür sind in Kapitel \ref{begriffe-sachverhalte-und-verfahren} zu Begriffen, Sachverhalten und Verfahren dargestellt. Eine solche Erarbeitung ist jedoch erst die \emph{Ausgangslage} für die individuelle Aneignung des Lerngegenstands durch die Schülerinnen und Schüler. Diese erfolgt dann in der Regel über das Bearbeiten von Aufgaben, die den Schülerinnen und Schülern gestellt werden (oder die sie sich selbst stellen). Hiermit sind nicht einseitig \emph{Übungsaufgaben} gemeint, sondern jegliche Art der Aufforderung, (spezifische) Lernhandlungen auszuführen.

Lernhandlungen können dabei in einen \emph{Orientierungs-}, einen \emph{Ausführungs-} und einen \emph{Kontrollteil} eingeteilt werden, wobei der Kontrollteil auch begleitend wirksam werden kann.

\hypertarget{orientierungsgrundlagen}{%
\subsection{Orientierungsgrundlagen}\label{orientierungsgrundlagen}}

Mit der Erfassung einer Aufgabe geht ad hoc eine Orientierung der Schülerinnen und Schüler bezüglich der möglichen Aufgabenbearbeitung einher. Dabei wird in drei Qualitäten von \textbf{\emph{Orientierungsgrundlagen}} unterschieden (als Zitate gekennzeichnete Formulierungen sind entnommen aus \protect\hyperlink{ref-Feldt-Caesar2017}{Feldt-Caesar, 2017, 83~ff.}):
...
\hypertarget{ausfuehren-und-verinnerlichen}{%
\subsection{Ausführen und Verinnerlichen}\label{ausfuehren-und-verinnerlichen}}
...
Um die Lernhandlungen zu \emph{verinnerlichen} (genauer: um sie \emph{anzueignen}, was stets als Einheit aus Entäußerung und Verinnerlichung anzusehen ist -- vgl. Abschnitt \ref{aneignung-von-lerngegenstaenden}) schlägt Gal'perin eine \textbf{»etappenweise Interiorisierung«} vor (vgl. \protect\hyperlink{ref-Lompscher1985a}{Lompscher, 1983, 66~f.}):
...
\hypertarget{handlungskontrolle}{%
\subsection{Handlungskontrolle}\label{handlungskontrolle}}
...
\hypertarget{bezuxfcge-zur-stoffdidaktik}{%
\section{Bezüge zur Stoffdidaktik}\label{bezuxfcge-zur-stoffdidaktik}}
...
Für die Unterrichtgestaltung wurde bisher verschwiegen, dass die Lernhandlungen selbstverständlich auf Vorkenntnisse und -fertigkeiten aufbauen und dieser bedürfen. Es ist daher unerlässlich, das für die neu zu erwerbenden Lernhandlungen benötigte \textbf{Ausgangsniveau zu sichern} (was dann die \emph{Zone der aktuellen Leistung} charakterisiert). Dies kann in \textbf{Wiederholungsphasen} zum aktuell benötigten Stoff erfolgen, dauerhaft und langfristig auch in (unbenoteten) \textbf{täglichen Übungen / vermischten Kopfübungen} zum »Wachhalten von Basiswissen« (siehe auch \protect\hyperlink{ref-Bruder2008b}{Bruder, 2008}).

Insgesamt ergeben sich aus den Überlegungen \textbf{typische Phasen einer Unterrichtsstunde}. Abbildung \ref{fig:Unterrichtsphasen} zeigt diese in Anlehnung an Bruder (\protect\hyperlink{ref-Bruder1991}{1991}) mit ihrem Zusammenhang zu den stoffdidaktichen Theoriebestandteilen.



\begin{figure}

{\centering \includegraphics[width=0.95\linewidth]{pictures/8-Unterrichtsphasen} 

}

\caption{Typische Unterrichtsphasen nach Bruder (\protect\hyperlink{ref-Bruder1991}{1991})}\label{fig:Unterrichtsphasen}
\end{figure}
...
\hypertarget{taetigkeitstheorie-nachbereitung}{%
...
\hypertarget{begriffe-sachverhalte-und-verfahren}{%
\chapter{Begriffe, Sachverhalte und Verfahren}\label{begriffe-sachverhalte-und-verfahren}}
...
\tightlist
\item
  Folien zum Kapitel 9 (\href{files/Stoffdidaktik2023-09-BegriffeSachverhalteUndVerfahren.pdf}{pdf}, \href{files/Stoffdidaktik2023-09-BegriffeSachverhalteUndVerfahren.key}{Keynote})
\end{itemize}
\end{quote}
...
Sie haben in der Einführung in die Mathematikdidaktik Möglichkeiten zur Begriffsbildung kennengelernt, bei denen der Fokus insbesondere auf dem Zusammenhang zwischen geeigneten \textbf{Beispielen und Gegenbeispielen} zum Begriff sowie der \textbf{Art der Begriffsfestlegung} lag.
Dieser nach Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 39}) auch als \emph{Begriffsbildung} bezeichnete Teilprozess ist jedoch noch nicht ausreichend dafür, ein Verständnis vom Begriff entwickelt zu haben -- ganz im Gegenteil, er stellt nur einen ersten Schritt dar. Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 46}) zufolge kann das Erlangen eines Begriffsverständnisses in einem idealisierten Modell in folgende Schritte eingeteilt werden:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Bildung des Begriffs} über Beispiele und Gegenbeispiele sowie der Begriffsfestlegung
\item
  \textbf{Entwicklung einer Orientierungshilfe}, abhängig davon, ob die Aneignung über Identifizierungs- oder Realisierungshandlungen erfolgen soll
\item
  \textbf{Etappenweise Verinnerlichung} der Aneignungshandlung
\item
  \textbf{Vertiefende Übungen} zum Festigen des Begriffs.
\end{enumerate}

\hypertarget{begriffe-bilden}{%
\subsection{Begriffe bilden}\label{begriffe-bilden}}

Hinweise zur Begriffsbildung finden Sie in der Vorlesung zur Einführung in die Mathematikdidaktik sowie im entsprechenden Kapitel im Skript zur Stoffdidaktik vom Wintersemester 2021/22: \url{https://stoffdidaktik.heiko-etzold.de/2021/6-begriffsbildung.html\#wege-zum-begriff}

\hypertarget{begriffe-aneignen}{%
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4000}}@{}}
\caption{\label{tab:begriffsschritte} Teilprozesse zur Begriffsbildung und -aneignung, nach Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 46})}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Identifizieren
...
\hypertarget{begriffe-festigen}{%
\subsection{Begriffe festigen}\label{begriffe-festigen}}

Vertiefende Übungen ergeben sich v.~a. durch die Einordnung des neu erlernten Begriffs in ein \textbf{Begriffssystem}. Hinzu kommt die Verwendung \textbf{alternativer Definitionen} sowie die \textbf{Variablität in der Verwendung von Bezeichnungen} (z.~B. Variablen). Auch können \textbf{Grenz- und Sonderfälle} des Begriffs diskutiert werden, um ein vertieftes Verständnis zu gewinnen (vgl. \protect\hyperlink{ref-Steinhofel1988}{Steinhöfel et al., 1988, S. 34}). Eine systematische Übersicht, auch für ein ähnliches Vorgehen bei Sachverhalten und Verfahren, bietet Tabelle \ref{tab:festigen}.

Nach Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, S. 48}) ist ein Begriff verstanden, wenn Schülerinnen und Schüler
...
Eine Vorgehensweise, die die Begriffsbildung, -aneignung und -festigung in eine unterrichtseffektive Struktur bringt, ist das Vorgehen nach dem \textbf{\emph{Aufsteigen vom Abstrakten zum Konkreten}}, siehe Abschnitt \ref{aufsteigen-vom-abstrakten-zum-konkreten}.

\hypertarget{sachverhalte}{%
\section{Sachverhalte}\label{sachverhalte}}

Bei Sachverhalten (also Regeln, Gesetzen und Sätzen) bietet es sich an, in der Erarbeitung zwischen dem \textbf{Finden des Sachverhalts}, dem \textbf{Finden einer Begründung} und der \textbf{Darstellung der Begründung} zu unterscheiden.\footnote{Spezifischer sprechen einige Quellen auch von der \emph{Satzfindung}, \emph{Beweisfindung} und \emph{Beweisdarstellung}, z.~B. Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 59})}
...
\hypertarget{sachverhalte-erarbeiten}{%
\subsection{Sachverhalte erarbeiten}\label{sachverhalte-erarbeiten}}

\hypertarget{sachverhalte-finden}{%
\subsubsection{Sachverhalte finden}\label{sachverhalte-finden}}

Für das Finden neuer Sachverhalte bestehen folgende Möglichkeiten (vgl. \protect\hyperlink{ref-Vollrath2012}{Vollrath \& Roth, 2012, 247~f.}):

\begin{itemize}
\item
  Der neue Sachverhalt wird \textbf{induktiv} über das Entdecken von Merkmalen in gegebenen Situationen erarbeitet.
  ...
  \end{quote}
\item
  Der neue Sachverhalt entsteht aus dem \textbf{Widerspruch zu einer angenommenen Hypothese}.

  \begin{quote}
  Aus dem Recheckbeispiel könnte angenommen werden, dass Vierecke mit sich halbierenden Diagonalen \emph{immer} Rechtecke sind. Über ein Gegenbeispiel kann aber gezeigt werden, dass dies auch bei Parallelogrammen der Fall ist. So wurde ein neuer Sachverhalt entdeckt.
  \end{quote}
\item
  Der neue Sachverhalt wird \textbf{deduktiv} aus bisherigen Sachverhalten gefolgert.
...
\item
  Über eine \textbf{Zusammenstellung wichtiger Sachverhalte und Definitionen} stehen notwendige Beweismittel zur Verfügung, vgl. auch Orientierungshilfen in Abschnitt \ref{sachverhalte-aneignen}.
\end{itemize}

\hypertarget{sachverhalte-aneignen}{%
\subsection{Sachverhalte aneignen}\label{sachverhalte-aneignen}}

Für die Aneignung eines neuen Sachverhaltes muss dieser an sich sowie seine Begründung angeeignet werden. Da beides eng miteinander zusammenhängt, sollte der Fokus daher auf der \emph{inneren Struktur} des Sachverhaltes liegen. Mögliche Lernhandlungen hierfür sind:

\begin{itemize}
\tightlist
\item
  \textbf{Prüfen der Voraussetzungen}, um die Anwendbarkeit und Gültigkeit der Behauptung zu schließen. Dies erfolgt i.~d.~R. anhand einer (in einer Aufgabe) gegebenen Situation. Es reicht nicht aus, den Sachverhalt nur anzuwenden, sondern das Prüfen der ihm zugrundeliegenden Voraussetzungen ist ein wesentlicher Schritt in dessen Aneignung. Im Endeffekt entspricht dieses Prüfen einer \emph{Identifizierungshandlung}.
\item
  \textbf{Angeben von Beispielen}, auf die der Sachverhalt anwendbar ist. Dies kann auch als \emph{Realisierungshandlung} aufgefasst werden.
\item
  \textbf{Herausarbeiten von Voraussetzung und Behauptung}, um die Aussage des Sachverhaltes zu verinnerlichen und dessen logische Struktur zu betonen. Dies kann auch über eine \emph{sprachliche Umformulierung} des Sachverhaltes (z.~B. als Wenn-dann-Aussage) erfolgen.
\end{itemize}
...
\begin{itemize}
\item
  In \textbf{strukturierten Wissensspeichern} kann ein Sachverhalt oder eine Gruppe von Sachverhalten so dargestellt werden, dass dessen/deren innere Struktur hervorgehoben wird. Hierzu bietet sich eine tabellarische Übersicht an, die neben dem Namen des Sachverhaltes auch dessen \textbf{Voraussetzungen} und \textbf{Behauptungen} sowie ggf. eine verallgemeinerte (ikonische oder symbolische) \textbf{Darstellung des Sachverhaltes} enthält.
  ...
  \caption{\label{tab:wissensspeicher} Strukturierter Wissensspeicher zu Winkelsätzen, angelehnt an Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 69})}\tabularnewline
  \toprule\noalign{}
  \begin{minipage}[b]{\linewidth}\raggedright
  Name des Satzes
  \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
  ...
  \bottomrule\noalign{}
  \endlastfoot
  Scheitelwinkelsatz & \(\alpha\) und \(\beta\) sind ein Scheitelwinkelpaar. & \includegraphics{pictures/9-Scheitelwinkel.png} & \(\alpha = \beta\) \\
  Nebenwinkelsatz & \(\alpha\) und \(\beta\) sind ein Nebenwinkelpaar. & \includegraphics{pictures/9-Nebenwinkel.png} & \(\alpha + \beta = 180°\) \\
  Stufenwinkelsatz & \(\alpha\) und \(\beta\) sind Stufenwinkel an geschnittenen Parallelen. & \includegraphics{pictures/9-Stufenwinkel.png} & \(\alpha = \beta\) \\
  Wechselwinkelsatz & \(\alpha\) und \(\beta\) sind Wechselwinkel an geschnittenen Parallelen. & \includegraphics{pictures/9-Wechselwinkel.png} & \(\alpha = \beta\) \\
  \end{longtable}
  \end{quote}
\item
  ...
  \end{quote}
\item
  Für das \emph{Finden einer Begründung} kann folgende \textbf{Handlungsvorschrift} als Orientierungshilfe dienen (angelehnt an \protect\hyperlink{ref-Steinhofel1988}{Steinhöfel et al., 1988, S. 72}):

  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  \tightlist
  \item
    Formulieren des Sachverhaltes als \textbf{Wenn-dann-Aussage}
  \item
...
\hypertarget{sachverhalte-festigen}{%
\subsection{Sachverhalte festigen}\label{sachverhalte-festigen}}

Zum Festigen von Sachverhalten eignet sich nach Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 34}) u.~a. die \textbf{Einschränkung einer oder mehrerer Voraussetzungen} oder das \textbf{Vertauschen von Voraussetzung und Behauptung}, um die weitere Gültigkeit zu prüfen. Wie auch schon bei Begriffen sollten weiterhin \textbf{Bezeichnungen variiert} und \textbf{alternative Formulierungen} betrachtet werden. Auch bietet es sich an, \textbf{Sachverhalte mit gleicher oder ähnlicher Behauptung} zu betrachten. Auch hier sei an die systematische Übersicht in Tabelle \ref{tab:festigen} verwiesen.

Nach Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, S. 49}) ist ein Sachverhalt verstanden, wenn Schülerinnen und Schüler
...
Verfahren dienen in der Mathematik der Verallgemeinerung einer \textbf{Lösung} von einem spezifischen Problem hin zu \textbf{einer ganzen Klasse von Problemen}. Für die ausführenden Schülerinnen und Schüler verschiebt sich damit der (idealerweise) \emph{kreative} Prozess bei der Behandlung von Begriffen und Sachverhalten hin zu einem \emph{disziplinierten} Arbeiten (vgl. \protect\hyperlink{ref-Vollrath2012}{Vollrath \& Roth, 2012, 262~f.}). Dabei darf das Verfahren jedoch nicht als geistig leeres Abarbeiten eines Lösungschemas verstanden werden, sondern auch die »Herkunft des Verfahrens« (z.~B. Begründung einzelner Schritte) sind Bestandteil der Verfahrenskenntnisse.

Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, S. 261}, Hervorhebungen im Original) zufolge beziehen sich Verfahren »in der \emph{Arithmetik} in erster Linie auf die Rechenoperationen in den verschiedenen Zahlbereichen, auf das Lösen von Sachaufgaben für Größen mit Hilfe von Funktionen sowie auf die Bestimmung von Funktionswerten; in der \emph{Algebra} betreffen sie das Lösen von Gleichungen, Gleichungssystemen und Ungleichungen; in der \emph{Geometrie} geht es um das Konstruieren, das Berechnen von Umfängen, Flächeninhalten und Rauminhalten, das Darstellen von Körpern und in der \emph{Trigonometrie} um die Dreiecksberechnungen.«

Dabei \textbf{bauen Verfahren auf Begriffe und Sachverhalte auf} -- benötigen i.~d.~R. sogar mehrere von ihnen. Diese müssen also sicher zur Verfügung stehen. Oftmals ist eine Hierarchie von Begriffen und Sachverhalten bzw. vorheriger Verfahren nötig, um neue Verfahren aufzubauen (z.~B. baut die schriftliche Multiplikation u.~a. auf die schriftliche Addition und das kleine Einmaleins im Kopf auf, vgl. \protect\hyperlink{ref-Vollrath2012}{Vollrath \& Roth, 2012, S. 262}). Die Behandlung von Verfahren dient damit gleichzeitig auch der vertiefenden Aneignung von Begriffen und Sachverhalten.

\hypertarget{verfahren-gewinnen}{%
...
Die letzten beiden Fragen beziehen sich auf das \emph{Ziel} (»Wozu?«) und den \emph{Weg} (»Warum?«) der jeweiligen Verfahrensschritte.\footnote{Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, S. 264}) verweisen hier auf die umgangssprachliche Vermischung der beiden Fragen »Wozu?« und »Warum?«.} Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, S. 264}) stellen am Beispiel des Lösens der Gleichung \(5x = 10\) dar, dass eine Unterscheidung zwischen Ziel (»die \(5\) auf die andere Seite bekommen«) und Weg (durch \(5\) dividieren) bei der Verfahrensgewinnung hilfreich sein kann. Während das Ziel die \emph{Notwendigkeit} des Schrittes begründet, nimmt der Weg Bezüge auf die im Hintergrund wirkenden Begriffe und Sachverhalte und liefert damit eine \emph{kausale Begründung} für den Verfahrensschritt.

\hypertarget{verfahren-aneignen}{%
\subsection{Verfahren aneignen}\label{verfahren-aneignen}}

Die Aneignung eines Verfahrens erfolgt i.~d.~R. über dessen Anwendung. Im Sinne der etappenweise Ausbildung bedeutet dies (\protect\hyperlink{ref-Steinhofel1988}{Steinhöfel et al., 1988, S. 118}):
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{\label{tab:festigen} Möglichkeiten zur Festigung von Begriffen, Sachverhalten und Verfahren, nach Steinhöfel et al. (\protect\hyperlink{ref-Steinhofel1988}{1988, S. 34})}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Begriffe
...
Weiterführende Möglichkeiten zur Erarbeitung von Begriffen, Sachverhalten und Verfahren stellen Vollrath \& Roth (\protect\hyperlink{ref-Vollrath2012}{2012, 227~ff.}) dar.

\hypertarget{intermezzo-arithmetisches-mittel}{%
\chapter{Intermezzo: Arithmetisches Mittel}\label{intermezzo-arithmetisches-mittel}}
...
\tightlist
\item
  Folien zum Kapitel 10 (\href{files/Stoffdidaktik2023-10-Intermezzo.pdf}{pdf}, \href{files/Stoffdidaktik2023-10-Intermezzo.key}{Keynote})
\item
  Virtuelles Arbeitsmittel zum Medien und arithmetischen Mittel (\href{files/Stoffdidaktik2023-10-Lagemasse.html}{html}, \href{files/Stoffdidaktik2023-10-Lagemasse.cdy}{Cinderella})
\end{itemize}
\end{quote}

\emph{Die Inhalte zu diesem Kapitel werden demnächst ergänzt.}

\hypertarget{stoffdidaktische-hintergruxfcnde}{%
\section{Stoffdidaktische Hintergründe}\label{stoffdidaktische-hintergruxfcnde}}

\hypertarget{unterrichtsplanung}{%
\section{Unterrichtsplanung}\label{unterrichtsplanung}}

\hypertarget{motivierung-und-zielbildung-1}{%
\subsection{Motivierung und Zielbildung}\label{motivierung-und-zielbildung-1}}

\hypertarget{stoffvermittlung}{%
\subsection{Stoffvermittlung}\label{stoffvermittlung}}

\hypertarget{festigung}{%
\subsection{Festigung}\label{festigung}}

\hypertarget{handlungskontrolle-1}{%
\subsection{Handlungskontrolle}\label{handlungskontrolle-1}}

\hypertarget{aufsteigen-vom-abstrakten-zum-konkreten}{%
\section{Aufsteigen vom Abstrakten zum Konkreten}\label{aufsteigen-vom-abstrakten-zum-konkreten}}

\hypertarget{part-didaktik-der-sachgebiete}{%
\part*{Didaktik der Sachgebiete}\label{part-didaktik-der-sachgebiete}}
\addcontentsline{toc}{part}{Didaktik der Sachgebiete}

\hypertarget{arithmetik-und-algebra}{%
...
\hypertarget{uxfcbergang-arithmetik-algebra}{%
\section{Übergang Arithmetik → Algebra}\label{uxfcbergang-arithmetik-algebra}}

»In der Arithmetik sind Zahlen die Objekte des Handelns.« Weigand et al. (\protect\hyperlink{ref-Weigand2022}{2022, S. 40}) formuliert diesen Satz, um im Kontrast dazu zu beschreiben, dass sich in der Algebra »der Fokus vom Handeln mit Zahlen zum Handeln mit unbekannten Größen {[}verändert{]}. Dabei können Lernende die bekannten Regeln des Operierens mit Zahlen auf die neuartige Situation übertragen, in der Zahlen unbekannt sind.«
Der Mathematikunterricht der Sekundarstufe I ist geprägt durch diesen gedanklichen Übergang von der Arithmetik zur Algebra, der aber durchaus auch schon in der Grundschule beginnen kann, etwa beim halbschriftlichen Rechnen (siehe z.~B. \protect\hyperlink{ref-Padberg2021}{Padberg \& Benz, 2021, 191~ff.}). »Aus der Perspektive des Lehrens und Lernens von Algebra beginnt die Auseinandersetzung mit Algebra dort, wo Lernende allgemeine arithmetische Strukturen erkennen oder erkunden« (\protect\hyperlink{ref-Weigand2022}{Weigand et al., 2022, S. 39}). Die bedeutsamsten Lerngegenstände zur Algebra sind demnach \textbf{Variablen}, \textbf{Terme} und \textbf{Gleichungen}.

Die Algebra erhält im Schulunterricht drei wesentliche Bedeutungen (Zitate entnommen aus \protect\hyperlink{ref-Weigand2022}{Weigand et al., 2022, S. 1~ff.}):
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/11-Musterfolge} 

}

\caption{Musterfolge zum Übergang der Arithmetik zur Algebra (\protect\hyperlink{ref-Weigand2022}{Weigand et al., 2022, S. 8})}\label{fig:Musterfolge}
\end{figure}
...
\hypertarget{wurzelbehandlung}{%
\subsection{Wurzelbehandlung}\label{wurzelbehandlung}}

Angelehnt an die \emph{Mathewerkstatt} für die Klassenstufe 9 (\protect\hyperlink{ref-Barzel2016}{Barzel et al., 2016, 92~ff.}) sowie die Überlegungen in den Kapiteln \ref{taetigkeitstheorie-und-lernen} und \ref{begriffe-sachverhalte-und-verfahren}, bietet sich folgende Behandlung des Wurzelbegriffs an:
...
\item
  ...
  \begin{figure}
   ...
   {\centering \includegraphics[width=0.5\linewidth]{pictures/11-Wurzel} 
...
{\centering \includegraphics[width=0.9\linewidth]{pictures/11-Heron} 
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/11-WurzelTabelle} 
...
\tightlist
\item
  Folien zum Kapitel 12 (\href{files/Stoffdidaktik2023-12-Analysis.pdf}{pdf}, \href{files/Stoffdidaktik2023-12-Analysis.key}{Keynote})
\end{itemize}
...
{\centering \includegraphics[width=0.9\linewidth]{pictures/12-Grenzwert} 

}

\caption{Visualisierung zum Grenzwertbegriff (\protect\hyperlink{ref-Enders2024}{Enders, 2024, S. 36})}\label{fig:Grenzwert}
\end{figure}
...
\item
  ...
  kommt bspw. nur jedes zweite Folgeglied dem Grenzwert \(\frac{1}{3}\) näher, dennoch konvergiert die Folge, weil bei vorgegebener Genauigkeit (\(\varepsilon\)) ein Folgeglied gefunden werden kann (\(a_{n_0}\)), ab dem alle diese Genauigkeit erfüllen (vgl. \protect\hyperlink{ref-Ableitinger2013b}{Ableitinger \& Heitzer, 2013, S. 7}).
\item
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/12-Kreis} 
...
\hypertarget{computer-algebra-systeme}{%
...
\hypertarget{software-und-hardware}{%
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/12-Befehl} 
...
\hypertarget{neue-aufgabenkultur}{%
...
\begin{itemize}
\item
  Kortenkamp (\protect\hyperlink{ref-Kortenkamp2007}{2007}) schlägt beispielsweise vor, das \textbf{CAS als Überprüfungsinstrument} zu verwenden, um selbst erzeugte Aufgaben zu prüfen. Im oben genannten Beispiel könnte eine Aufgabenstellung lauten: »Stell eine quadratische Gleichung auf, die \(\sqrt{5}\) als Lösung hat.« Solche Aufgaben können dann schrittweise variiert und komplexer gestaltet werden (»Stell eine quadratische Gleichung auf, die nur \(\sqrt{5}\) als Lösung hat« usw.).
\item
...
\tightlist
\item
  Folien zum Kapitel 13 (\href{files/Stoffdidaktik2023-13-Geometrie.pdf}{pdf}, \href{files/Stoffdidaktik2023-13-Geometrie.key}{Keynote})
\end{itemize}
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/13-Mittelsenkrechte} 
...
In analoger Weise zur Faltung der Mittelsenkrechten durch Punkt-auf-Punkt-Faltung kann auch das Falten einer Winkelhalbierenden durch Kante-auf-Kante-Faltung realisiert werden. Darauf aufbauend wiederum können Senkrechten, Parallelen oder sogar Quadrate bzw. Kreismittelpunkte gefaltet werden (siehe \protect\hyperlink{ref-Etzold2014a}{Etzold \& Petzschler, 2014, 10, 82~f., 86~f.}).

\hypertarget{skalarprodukt}{%
\subsection{Skalarprodukt}\label{skalarprodukt}}

Zur Beschreibung von Lagebeziehungen zweier Geraden, insbesondere der Bestimmung des Winkels dazwischen, wird in der Sekundarstufe II das Skalarprodukt behandelt. Nach Henn \& Filler (\protect\hyperlink{ref-Henn2015}{2015, S. 195}~ff.) bestehen hierfür prinzipiell drei Zugänge:
...
{\centering \includegraphics[width=0.3\linewidth]{pictures/13-Skalarprodukt} 
...
{\centering \includegraphics[width=0.5\linewidth]{pictures/13-Dreieck} 
...
\hypertarget{dynamische-geometriesysteme}{%
...
Zum Umgang mit DGS gibt es vielfältige Forschungs- und Entwicklungsergebnisse, die auch in den Didaktiken der einzelnen Sachgebiete referenziert werden (u.~a. bei \protect\hyperlink{ref-Greefrath2016}{Greefrath et al., 2016, 41~f., 65~f., 155~f.}; \protect\hyperlink{ref-Weigand2018}{Weigand et al., 2018, 62~ff.}).
...
\tightlist
\item
  Folien zum Kapitel 14 (\href{files/Stoffdidaktik2023-14-Stochastik.pdf}{pdf}, \href{files/Stoffdidaktik2023-14-Stochastik.key}{Keynote})
\item
  Virtuelles Arbeitsmittel zum Boxplot (\href{files/Stoffdidaktik2023-14-Boxplot.html}{html}, \href{files/Stoffdidaktik2023-14-Boxplot.cdy}{Cinderella})
\end{itemize}
...
Zur Unterstützung der Schülerinnen und Schüler in der Beschreibung stochastischer Vorgänge schlagen Krüger et al. (\protect\hyperlink{ref-Kruger2015}{2015, 14~f.}) die Nutzung einer \textbf{Prozessbetrachtung} vor (siehe Abbildung \ref{fig:Prozessbetrachtung}).
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/14-Reihenfolge} 
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/14-Wiederholung} 
...
{\centering \includegraphics[width=0.95\linewidth]{pictures/14-Kombinatorik} 
...
Krüger et al. (\protect\hyperlink{ref-Kruger2015}{2015, S. 123}) empfehlen in der Einführung von Boxplots, zunächst auf die Behandlung von Ausreißern zu verzichten und parallel zum Boxplot die Daten als Punktdiagramm darzustellen (siehe Abbildung \ref{fig:Boxplot}).



\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{pictures/14-Boxplot} 

}

\caption{Boxplot mit Punktdiagramm (\protect\hyperlink{ref-Kruger2015}{Krüger et al., 2015, S. 123})}\label{fig:Boxplot}
\end{figure}

Abbildung \ref{fig:ScreenshotBoxplot} zeigt den Screenshot eines \href{files/Stoffdidaktik2023-14-Boxplot.html}{virtuellen Arbeitsmittels} zur Erkundung von Zusammenhängen am Boxplot, das im Rahmen einer Masterarbeit an der Universität Potsdam entstanden ist (\protect\hyperlink{ref-Korn2023}{Korn, 2023}).

\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{pictures/14-ScreenshotBoxplot} 
...
\hypertarget{sammlung-von-lernbereichen}{%
\chapter{Sammlung von Lernbereichen}\label{sammlung-von-lernbereichen}}

Die folgende Sammlung von Lernbereichen ist im Rahmen des Seminars zur Stoffdidaktik-Veranstaltung entstanden und berücksichtigt die Brandenburger Rahmenlehrpläne für die Klassenstufen 1~--~10 bzw. die gymnasiale Oberstufe (\protect\hyperlink{ref-MinisteriumfurBildungJugendundSportdesLandesBrandenburg2022}{Ministerium für Bildung, Jugend und Sport des Landes Brandenburg, 2022b}, \protect\hyperlink{ref-MinisteriumfuerBildungJugendundSportdesLandesBrandenburg2023}{2023}).

Die Darstellung nach Klassenstufen orientiert sich an den Niveaustufen für den gymnasialen Bildungsgang (vgl. \protect\hyperlink{ref-MinisteriumfuerBildungJugendundSportdesLandesBrandenburg2023}{Ministerium für Bildung, Jugend und Sport des Landes Brandenburg, 2023, S. 20}).

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{pictures/A-SammlungLernbereiche} 

}

\caption{Übersicht zu Lernbereichen}\label{fig:SammlungLernbereiche}
\end{figure}

Die Übersicht kann als \href{files/Stoffdidaktik2023-SammlungLernbereiche.pdf}{pdf-Datei} heruntergeladen werden.
...
\leavevmode\vadjust pre{\hypertarget{ref-Ableitinger2013b}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Bruder2008b}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Enders2024}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Heinrich2007}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Korn2023}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Kortenkamp1999}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Kortenkamp2007}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Kortenkamp2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Labs2008}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-MinisteriumfurBildungJugendundSportdesLandesBrandenburg2022a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Padberg2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Richter2016}{}}%
