...
```{r SubjektObjekt2b, echo=FALSE, fig.cap="Die Nutzung eines Zirkels zur Aneignung des Kreis-Begriffs", fig.align='center', out.width='75%'}
...
```{r Etappenb, echo=FALSE, fig.cap="(ref:citeEtappen)", fig.align='center', out.width='90%'}
...
```{r Unterrichtsphasenb, echo=FALSE, fig.cap="(ref:citeUnterrichtsphasen)", fig.align='center', out.width='95%'}
