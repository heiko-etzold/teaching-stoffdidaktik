...
<!-- > **Material** -->
<!-- > -->
<!-- > + Folien zur Vorlesung zur Gestaltung von Aufgaben ([pdf](files/Stoffdidaktik-WiSe2122-Kap10.pdf), [Keynote](files/Stoffdidaktik-WiSe2122-Kap10.key)) -->
...
(ref:citeSchwierig) Unterschiedlich schwere Aufgaben zum Prismenvolument [aus @Druke-Noe2018 10]
...
* Die Aufgabe *»Zeichne ein Dreieck mit einem Flächeninhalt von 13 cm².«* ermöglicht dagegen alle Orientierungstypen. Die Aufgabe ist sowohl über Versuch und Irrtum lösbar (z. B. mit einem Dynamischen Geometriesystem, das den Flächeninhalt eine Dreicks unmittelbar darstellen kann, nachdem es gezeichnet wurde), als auch mit einer Musterorientierung (wenn man sich an ähnlich durchgeführten Beispielen orientiert) sowie einer Feldorientierung (wenn man sich über den Bezug zur Flächeninhaltsformel darüber im Klaren wird, dass ausschließlich die Grundseite und Höhe des Dreiecks relevant sind -- also bspw. auch eine ganze Klasse von Lösungen erzeugt werden kann).   
